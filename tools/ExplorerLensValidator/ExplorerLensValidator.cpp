...
public:
    ExplorerLensValidator(bool verbose = false) : m_verbose(verbose) {}
    
    ~ExplorerLensValidator() {
        if (m_engineDll) {
    ...
    bool Initialize() {
        ...
        std::wstring enginePath = L"ExplorerLensEngine.dll";
        
        // Check in standard locations
        std::vector<std::wstring> searchPaths = {
            L"..\\x64\\Release\\ExplorerLensEngine.dll",
            L"..\\..\\x64\\Release\\ExplorerLensEngine.dll",
            L"..\\Engine\\Release\\Release\\ExplorerLensEngine.dll",
            L"ExplorerLensEngine.dll"
        };
...
void PrintUsage() {
    std::wcout << L"ExplorerLens Validator v1.0\n"
              << L"Usage: ExplorerLensValidator.exe [options] <path>\n\n"
              << L"Options:\n"
              ...
              << L"Examples:\n"
              << L"  ExplorerLensValidator.exe tests\\data\\corpus\n"
              << L"  ExplorerLensValidator.exe -v -o results.csv tests\\data\\corpus\n"
              << std::endl;
}
...
int wmain(int argc, wchar_t* argv[]) {
    ...
    ExplorerLensValidator validator(verbose);
