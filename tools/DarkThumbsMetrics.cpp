// DarkThumbs Metrics Viewer - Command-line tool to view performance metrics
...
#include <iomanip>
#include <psapi.h>
#include "../CBXShell/metrics_collector.h"
...
void DisplayMetrics() {
    ...
    PrintHeader("DarkThumbs Performance Metrics");
...
void PrintUsage() {
    std::cout << "DarkThumbs Metrics Viewer\n";
    std::cout << "Usage: DarkThumbsMetrics.exe [command] [options]\n\n";
    std::cout << "Commands:\n";
    ...
    std::cout << "Examples:\n";
    std::cout << "  DarkThumbsMetrics.exe\n";
    std::cout << "  DarkThumbsMetrics.exe show\n";
    std::cout << "  DarkThumbsMetrics.exe export csv metrics.csv\n";
    std::cout << "  DarkThumbsMetrics.exe export json metrics.json\n";
    std::cout << "  DarkThumbsMetrics.exe reset\n";
}
