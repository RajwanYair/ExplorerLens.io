...
public:
	...
	LRESULT OnInitDialog(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
	{
		...
		// Set dialog title
		SetWindowText(_T("Configuration Changes Applied - DarkThumbs"));
	...
	LRESULT OnSaveConfig(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/)
	{
		...
		CFileDialog dlg(FALSE, _T("reg"), _T("DarkThumbs_Config"),
			...
			if (success)
			{
				...
				if (isRegFile)
				{
					msg.Format(_T("Configuration saved successfully to:\r\n%s\r\n\r\n")
						...
						_T("• Or use 'Load Config...' button in DarkThumbs\r\n\r\n")
...
private:
	...
	static bool SaveConfigToRegFile(LPCTSTR filename, const ConfigSnapshot& config)
	{
		...
		regData += "; DarkThumbs Shell Manager Configuration\r\n";
		regData += "; Generated: ";
	...
	static bool SaveConfigToFile(LPCTSTR filename, const ConfigSnapshot& config)
	{
		...
		json = "{\r\n";
		json += "  \"version\": \"1.0\",\r\n";
		json += "  \"application\": \"DarkThumbs Shell Manager\",\r\n";
