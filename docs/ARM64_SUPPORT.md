...
ExplorerLens v15.0.0 introduces foundational ARM64 support as part of the v15.0.0 development cycle.
...
The `ARM64RuntimeValidator` (see `Engine/Utils/ARM64Platform.h`) performs
...
## CI Integration ( — `.github/workflows/arm64.yml`)
...
|------------------------------|---------|--------------------------------------------|
| `ARM64Platform.h`            | v15.0.0 | Consolidated: build config, library matrix, runtime validation, perf baselines, CI integration |
...
|-----------|-------------------------------|--------|
| 1 | ARM64 Build Configuration | ✅ Done |
| 2 | ARM64 Library Compatibility Matrix | ✅ Done |
| 3 | ARM64 Runtime Validator | ✅ Done |
| 4 | ARM64 Performance Baseline | ✅ Done |
| 5 | ARM64 CI Integration | ✅ Done |

---

*Document created: | Version: v15.0.0 | Last updated: *
