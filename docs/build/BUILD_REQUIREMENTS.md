# ExplorerLens.io - Build Requirements (64-bit Only)
...
## Build Tools Status (Verified: 2026-03-08)

| Tool | Version | Source | Status |
|------|---------|--------|--------|
| CMake | 4.2.3 | scoop | ✅ Up-to-date |
| Ninja | 1.13.2 | scoop | ✅ Up-to-date |
| MSBuild | 18.3.0 | VS BuildTools 2026 | ✅ Up-to-date |
| Git | 2.53.0 | scoop | ✅ Up-to-date |
| NASM | 3.01 | scoop | ✅ Up-to-date |
| 7zip | 26.00 | scoop | ✅ Up-to-date |
...
4. Output: `x64/Release/LENSShell.dll` and `LENSManager.exe`
...
- `LENSShell/DarkModeHelper.h` - Dark mode detection utilities
- `LENSShell/ModernCppHelper.h` - C++17 filesystem wrappers
...
- `LENSShell/LENSShellClass.h` - Added IThumbnailProvider, IInitializeWithStream
- `LENSShell/LENSShellClass.cpp` - Implemented modern interfaces
- `LENSShell/cbxArchive.h` - Dark mode support, C++17 filesystem
- `LENSShell/targetver.h` - Updated to Windows 10/11
- `LENSShell/LENSShell.vcxproj` - VS 2022, C++17, security flags
- `LENSManager/LENSManager.vcxproj` - VS 2022, C++17, security flags
- `LENSShell/LENSShell.manifest` - DPI awareness
- `LENSManager/LENSManager.manifest` - DPI awareness + elevation
...
1. **Register Shell Extension** (as Administrator):
 ...
 ```cmd
 regsvr32 /i "x64\Release\LENSShell.dll"
 ```
