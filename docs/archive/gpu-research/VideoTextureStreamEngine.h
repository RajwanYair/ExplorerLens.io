...
class VideoTextureStreamEngine
{
  public:
    ...
    VTSEUploadMode PreferredMode() const
    {
        return VTSEUploadMode::ZeroCopy_DMA;
    }
    uint32_t MaxConcurrentStreams() const
    {
        return 8u;
    }
};
