# DarkThumbs v7.0.0 - PowerShell Profile Configuration
...
# ============================================================================
# DarkThumbs Build Environment Configuration
# ============================================================================

Write-Host "Initializing DarkThumbs build environment..." -ForegroundColor Cyan
...
Write-Host "DarkThumbs build environment ready!" -ForegroundColor Green
Write-Host ""

# ============================================================================
# Optional: DarkThumbs Helper Aliases
# ============================================================================

# Quick navigation to DarkThumbs project (customize this path)
$darkThumbsPath = "$env:USERPROFILE\OneDrive - Intel Corporation\Documents\MyScripts\DarkThumbs"
if (Test-Path $darkThumbsPath) {
    function dt { Set-Location $darkThumbsPath }
    Write-Host "Alias 'dt' created for DarkThumbs directory" -ForegroundColor Gray
}

# Quick build commands
function Build-DarkThumbs {
    param([string]$Config = "Release")
    & "$darkThumbsPath\scripts\build.ps1" -Configuration $Config
}

function Build-DarkThumbsEngine {
    param([string]$Config = "Release")
    cmake --build "$darkThumbsPath\build" --config $Config --target DarkThumbsEngine -j 8
}

function Test-DarkThumbs {
    ctest --test-dir "$darkThumbsPath\build" -C Release --output-on-failure
}

Set-Alias build Build-DarkThumbs
Set-Alias build-engine Build-DarkThumbsEngine
Set-Alias test Test-DarkThumbs
...
Write-Host "Type 'dt' to navigate to DarkThumbs" -ForegroundColor Gray
Write-Host ""
