...
Write-Host "DarkThumbs Diagnostics Configuration" -ForegroundColor Cyan
Write-Host "=====================================`n" -ForegroundColor Cyan

# Registry paths
$settingsPath = "HKCU:\Software\DarkThumbs\Settings"
$cachePath = "HKCU:\Software\DarkThumbs\Cache"
...
# Cache location
$diskCachePath = "$env:LOCALAPPDATA\DarkThumbs\cache"
...
if ($Logging -or $Profiling -or $MemoryTracking) {
    ...
    Write-Host "  .\Deploy-DarkThumbs.ps1 -Update" -ForegroundColor Gray
} else {
