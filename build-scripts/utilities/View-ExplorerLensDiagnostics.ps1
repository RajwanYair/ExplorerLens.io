# View-ExplorerLensDiagnostics.ps1
...
Write-Host "ExplorerLens Diagnostics Viewer" -ForegroundColor Cyan
Write-Host "================================`n" -ForegroundColor Cyan

$logPath = "$env:LOCALAPPDATA\ExplorerLens\logs"
$cachePath = "$env:LOCALAPPDATA\ExplorerLens\cache"
...
if (Test-Path $settingsPath) {
    ...
    Write-Host "  Not configured (run Enable-ExplorerLensDiagnostics.ps1)" -ForegroundColor Yellow
}
...
# Configuration info
$cacheRegPath = "HKCU:\Software\ExplorerLens\Cache"
