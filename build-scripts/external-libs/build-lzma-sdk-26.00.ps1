...
# Build LZMA SDK 26.00 static library for Windows x64

$ErrorActionPreference = "Stop"

Write-Host "`n========================================" -ForegroundColor Cyan
Write-Host "Building LZMA SDK 26.00" -ForegroundColor Cyan
Write-Host "========================================`n" -ForegroundColor Cyan
...
# Check headers
$headerDir = Join-Path $installDir "include"
if (Test-Path $headerDir) {
    $headers = Get-ChildItem $headerDir -Filter "*.h" -Recurse
...
Write-Host "✓ LZMA SDK 26.00 Build Complete" -ForegroundColor Green
Write-Host "========================================`n" -ForegroundColor Green
