  ...
  public:
    ...
    HandlerStatus GetGroupHandlerStatus(int LENSTYPE)
    {
        ...
        static const LPCTSTR s_videoExts[] = {
            _T(".MP4"),  _T(".AVI"),  _T(".MKV"),  _T(".MOV"),  _T(".WMV"), _T(".FLV"),  _T(".WEBM"),
            _T(".M4V"),  _T(".MPG"),  _T(".MPEG"), _T(".ASF"),  _T(".M1V"), _T(".M2V"),  _T(".TS"),
            _T(".M2TS"), _T(".MTS"),  _T(".M2T"),  _T(".MP4V"), _T(".3G2"), _T(".3GP"),  _T(".3GP2"),
            _T(".3GPP"), _T(".MK3D"), _T(".F4V"),  _T(".OGM"),  _T(".OGV"), _T(".RM"),   _T(".RMVB"),
            _T(".DV"),   _T(".MXF"),  _T(".IVF"),  _T(".EVO"),  _T(".264"), _T(".VIDEO")};
        static const LPCTSTR s_audioExts[] = {_T(".MP3"), _T(".FLAC"), _T(".WAV"),  _T(".OGG"), _T(".M4A"),
        ...
        if (LENSTYPE == LENS_VIDEO) {
            exts = s_videoExts;
            count = _countof(s_videoExts);
        } else if (LENSTYPE == LENS_AUDIO) {
            exts = s_audioExts;
            count = _countof(s_audioExts);
        } else {
    ...
    {
        CString regPath;
        regPath.Format(_T("%s\\shellex\\{BB2E617C-0920-11d1-9A0B-00C04FC2D6C1}"), dotExt);
    ...
    BOOL BackupHandler(int LENSTYPE, LPCTSTR keyPath, LPCTSTR backupName)
    {
        ...
        if (ERROR_SUCCESS == rk.Open(HKEY_CURRENT_USER, keyPath, KEY_READ)) {
            if (ERROR_SUCCESS == rk.QueryStringValue(NULL, existingGuid, &len)) {
                ...
                CRegKey rkBackup;
                if (ERROR_SUCCESS
                    == rkBackup.Create(HKEY_CURRENT_USER, backupKey, NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE)) {
    ...
    void SetHandlers(int LENSTYPE, BOOL bSet)
    {
        ...
        if (LENSTYPE == LENS_VIDEO) {
            ...
            const LPCTSTR backupNames[] = {
                _T("mp4_th"),  _T("avi_th"),  _T("mkv_th"),  _T("mov_th"),  _T("wmv_th"), _T("flv_th"),  _T("webm_th"),
                _T("m4v_th"),  _T("mpg_th"),  _T("mpeg_th"), _T("asf_th"),  _T("m1v_th"), _T("m2v_th"),  _T("ts_th"),
                _T("m2ts_th"), _T("mts_th"),  _T("m2t_th"),  _T("mp4v_th"), _T("3g2_th"), _T("3gp_th"),  _T("3gp2_th"),
                _T("3gpp_th"), _T("mk3d_th"), _T("f4v_th"),  _T("ogm_th"),  _T("ogv_th"), _T("rm_th"),   _T("rmvb_th"),
                _T("dv_th"),   _T("mxf_th"),  _T("ivf_th"),  _T("evo_th"),  _T("264_th"), _T("video_th")};
            const LPCTSTR backupNamesInfo[] = {
                _T("mp4_ih"),  _T("avi_ih"),  _T("mkv_ih"),  _T("mov_ih"),  _T("wmv_ih"), _T("flv_ih"),  _T("webm_ih"),
                _T("m4v_ih"),  _T("mpg_ih"),  _T("mpeg_ih"), _T("asf_ih"),  _T("m1v_ih"), _T("m2v_ih"),  _T("ts_ih"),
                _T("m2ts_ih"), _T("mts_ih"),  _T("m2t_ih"),  _T("mp4v_ih"), _T("3g2_ih"), _T("3gp_ih"),  _T("3gp2_ih"),
                _T("3gpp_ih"), _T("mk3d_ih"), _T("f4v_ih"),  _T("ogm_ih"),  _T("ogv_ih"), _T("rm_ih"),   _T("rmvb_ih"),
                _T("dv_ih"),   _T("mxf_ih"),  _T("ivf_ih"),  _T("evo_ih"),  _T("264_ih"), _T("video_ih")};
            ...
            for (int i = 0; i < _countof(videoExts); i++) {
                if (bSet) {
                    ...
                    CRegKey rkt, rki;
                    if (ERROR_SUCCESS
                        == rkt.Create(HKEY_CURRENT_USER, videoExts[i], NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE))
                        rkt.SetStringValue(NULL, LENS_GUID_KEY);
                    if (ERROR_SUCCESS
                        == rki.Create(HKEY_CURRENT_USER, videoInfoTips[i], NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE))
            ...
            const LPCTSTR heifInfoTips[] = {
                LENS_HEIFIH_KEY, LENS_HEICIH_KEY,
            ...
            for (int i = 0; i < _countof(heifExts); i++) {
                if (bSet) {
                    ...
                    CRegKey rkt, rki;
                    if (ERROR_SUCCESS
                        == rkt.Create(HKEY_CURRENT_USER, heifExts[i], NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE))
                        rkt.SetStringValue(NULL, LENS_GUID_KEY);
                    if (ERROR_SUCCESS
                        == rki.Create(HKEY_CURRENT_USER, heifInfoTips[i], NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE))
                        rki.SetStringValue(NULL, LENS_GUID_KEY);
                } else {
                    // Smart uninstall
                    TCHAR currentGuid[256] = {0};
            ...
            const LPCTSTR tiffExts[] = {LENS_TIFFTH_KEY, _T("SOFTWARE\\Classes\\.TIFF\\shellex\\{")
                                                         _T("BB2E617C-0920-11d1-9A0B-00C04FC2D6C1}")};
            const LPCTSTR tiffInfoTips[] = {LENS_TIFFIH_KEY, _T("SOFTWARE\\Classes\\.TIFF\\shellex\\{00021500-")
            ...
            for (int i = 0; i < _countof(tiffExts); i++) {
                if (bSet) {
                    ...
                    CRegKey rkt, rki;
                    if (ERROR_SUCCESS
                        == rkt.Create(HKEY_CURRENT_USER, tiffExts[i], NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE))
                        rkt.SetStringValue(NULL, LENS_GUID_KEY);
                    if (ERROR_SUCCESS
                        == rki.Create(HKEY_CURRENT_USER, tiffInfoTips[i], NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE))
                        rki.SetStringValue(NULL, LENS_GUID_KEY);
                } else {
                    // Smart uninstall
                    TCHAR currentGuid[256] = {0};
            ...
            const LPCTSTR rawExts[] = {LENS_DNGTH_KEY,
                                       ...
                                       _T("BB2E617C-0920-11d1-9A0B-00C04FC2D6C1}")};
            const LPCTSTR rawInfoTips[] = {LENS_DNGIH_KEY,
                                           ...
                                           _T("000000000046}")};
            const LPCTSTR backupNames[] = {_T("dng_th"), _T("cr2_th"), _T("cr3_th"), _T("nef_th"),
                                           _T("arw_th"), _T("orf_th"), _T("rw2_th"), _T("pef_th"),
                                           _T("raf_th"), _T("srw_th"), _T("nrw_th")};
            const LPCTSTR backupNamesInfo[] = {_T("dng_ih"), _T("cr2_ih"), _T("cr3_ih"), _T("nef_ih"),
                                               _T("arw_ih"), _T("orf_ih"), _T("rw2_ih"), _T("pef_ih"),
                                               _T("raf_ih"), _T("srw_ih"), _T("nrw_ih")};
            ...
            for (int i = 0; i < _countof(rawExts); i++) {
                if (bSet) {
                    ...
                    CRegKey rkt, rki;
                    if (ERROR_SUCCESS
                        == rkt.Create(HKEY_CURRENT_USER, rawExts[i], NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE))
                        rkt.SetStringValue(NULL, LENS_GUID_KEY);
                    if (ERROR_SUCCESS
                        == rki.Create(HKEY_CURRENT_USER, rawInfoTips[i], NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE))
                        rki.SetStringValue(NULL, LENS_GUID_KEY);
                } else {
                    // Smart uninstall
                    TCHAR currentGuid[256] = {0};
            ...
            const LPCTSTR backupNames[] = {_T("mp3_th"), _T("flac_th"), _T("wav_th"),  _T("ogg_th"), _T("m4a_th"),
                                           _T("wma_th"), _T("aac_th"),  _T("opus_th"), _T("ape_th"), _T("mka_th"),
                                           _T("mpc_th"), _T("tak_th"),  _T("wv_th")};
            const LPCTSTR backupNamesInfo[] = {_T("mp3_ih"), _T("flac_ih"), _T("wav_ih"),  _T("ogg_ih"), _T("m4a_ih"),
                                               _T("wma_ih"), _T("aac_ih"),  _T("opus_ih"), _T("ape_ih"), _T("mka_ih"),
                                               _T("mpc_ih"), _T("tak_ih"),  _T("wv_ih")};
            for (int i = 0; i < _countof(audioExts); i++) {
                if (bSet) {
                    ...
                    CRegKey rkt, rki;
                    if (ERROR_SUCCESS
                        == rkt.Create(HKEY_CURRENT_USER, audioExts[i], NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE))
                        rkt.SetStringValue(NULL, LENS_GUID_KEY);
                    if (ERROR_SUCCESS
                        == rki.Create(HKEY_CURRENT_USER, audioInfoTips[i], NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE))
                        rki.SetStringValue(NULL, LENS_GUID_KEY);
                } else {
                    TCHAR currentGuid[256] = {0};
                    ULONG len = 256;
            ...
            const LPCTSTR docExts[] = {LENS_DOCXTH_KEY,
            ...
            for (int i = 0; i < _countof(docExts); i++) {
                if (bSet) {
                    ...
                    CRegKey rkt, rki;
                    if (ERROR_SUCCESS
                        == rkt.Create(HKEY_CURRENT_USER, docExts[i], NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE))
                        rkt.SetStringValue(NULL, LENS_GUID_KEY);
                    if (ERROR_SUCCESS
                        == rki.Create(HKEY_CURRENT_USER, docInfoTips[i], NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE))
                        rki.SetStringValue(NULL, LENS_GUID_KEY);
                } else {
                    TCHAR currentGuid[256] = {0};
                    ULONG len = 256;
            ...
            const LPCTSTR fontExts[] = {
                LENS_TTFTH_KEY, _T("SOFTWARE\\Classes\\.OTF\\shellex\\{BB2E617C-0920-11d1-9A0B-00C04FC2D6C1}"),
            ...
            const LPCTSTR fontInfoTips[] = {
                LENS_TTFIH_KEY, _T("SOFTWARE\\Classes\\.OTF\\shellex\\{00021500-0000-0000-C000-000000000046}"),
            ...
            for (int i = 0; i < _countof(fontExts); i++) {
                if (bSet) {
                    ...
                    CRegKey rkt, rki;
                    if (ERROR_SUCCESS
                        == rkt.Create(HKEY_CURRENT_USER, fontExts[i], NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE))
                        rkt.SetStringValue(NULL, LENS_GUID_KEY);
                    if (ERROR_SUCCESS
                        == rki.Create(HKEY_CURRENT_USER, fontInfoTips[i], NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE))
                        rki.SetStringValue(NULL, LENS_GUID_KEY);
                } else {
                    TCHAR currentGuid[256] = {0};
                    ULONG len = 256;
            ...
            const LPCTSTR backupNames[] = {_T("stl_th"), _T("obj_th"), _T("gltf_th"), _T("glb_th"),
                                           _T("fbx_th"), _T("3ds_th"), _T("ply_th")};
            const LPCTSTR backupNamesInfo[] = {_T("stl_ih"), _T("obj_ih"), _T("gltf_ih"), _T("glb_ih"),
                                               _T("fbx_ih"), _T("3ds_ih"), _T("ply_ih")};
            for (int i = 0; i < _countof(modelExts); i++) {
                if (bSet) {
                    ...
                    CRegKey rkt, rki;
                    if (ERROR_SUCCESS
                        == rkt.Create(HKEY_CURRENT_USER, modelExts[i], NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE))
                        rkt.SetStringValue(NULL, LENS_GUID_KEY);
                    if (ERROR_SUCCESS
                        == rki.Create(HKEY_CURRENT_USER, modelInfoTips[i], NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE))
                        rki.SetStringValue(NULL, LENS_GUID_KEY);
                } else {
                    TCHAR currentGuid[256] = {0};
                    ULONG len = 256;
            ...
            const LPCTSTR backupNames[] = {_T("bmp_th"), _T("gif_th"), _T("wmf_th"), _T("emf_th"),
                                           _T("pcx_th"), _T("jp2_th"), _T("eps_th"), _T("ora_th"),
                                           _T("xcf_th"), _T("sgi_th"), _T("xpm_th"), _T("ff_th")};
            const LPCTSTR backupNamesInfo[] = {_T("bmp_ih"), _T("gif_ih"), _T("wmf_ih"), _T("emf_ih"),
                                               _T("pcx_ih"), _T("jp2_ih"), _T("eps_ih"), _T("ora_ih"),
                                               _T("xcf_ih"), _T("sgi_ih"), _T("xpm_ih"), _T("ff_ih")};
            for (int i = 0; i < _countof(extImgExts); i++) {
                if (bSet) {
                    ...
                    CRegKey rkt, rki;
                    if (ERROR_SUCCESS
                        == rkt.Create(HKEY_CURRENT_USER, extImgExts[i], NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE))
                        rkt.SetStringValue(NULL, LENS_GUID_KEY);
                    if (ERROR_SUCCESS
                        == rki.Create(HKEY_CURRENT_USER, extImgInfoTips[i], NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE))
                        rki.SetStringValue(NULL, LENS_GUID_KEY);
                } else {
                    TCHAR currentGuid[256] = {0};
                    ULONG len = 256;
            ...
            const LPCTSTR texExts[] = {LENS_KTXTH_KEY,
            ...
            const LPCTSTR texInfoTips[] = {
                LENS_KTXIH_KEY, _T("SOFTWARE\\Classes\\.KTX2\\shellex\\{00021500-0000-0000-C000-000000000046}"),
            ...
            for (int i = 0; i < _countof(texExts); i++) {
                if (bSet) {
                    ...
                    CRegKey rkt, rki;
                    if (ERROR_SUCCESS
                        == rkt.Create(HKEY_CURRENT_USER, texExts[i], NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE))
                        rkt.SetStringValue(NULL, LENS_GUID_KEY);
                    if (ERROR_SUCCESS
                        == rki.Create(HKEY_CURRENT_USER, texInfoTips[i], NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE))
                        rki.SetStringValue(NULL, LENS_GUID_KEY);
                } else {
                    TCHAR currentGuid[256] = {0};
                    ULONG len = 256;
            ...
            const LPCTSTR backupNames[] = {_T("iso_th"), _T("cab_th"), _T("cpio_th"), _T("bz2_th"),
                                           _T("zst_th"), _T("xz_th"),  _T("lz4_th")};
            const LPCTSTR backupNamesInfo[] = {_T("iso_ih"), _T("cab_ih"), _T("cpio_ih"), _T("bz2_ih"),
                                               _T("zst_ih"), _T("xz_ih"),  _T("lz4_ih")};
            for (int i = 0; i < _countof(extArcExts); i++) {
                if (bSet) {
                    ...
                    CRegKey rkt, rki;
                    if (ERROR_SUCCESS
                        == rkt.Create(HKEY_CURRENT_USER, extArcExts[i], NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE))
                        rkt.SetStringValue(NULL, LENS_GUID_KEY);
                    if (ERROR_SUCCESS
                        == rki.Create(HKEY_CURRENT_USER, extArcInfoTips[i], NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE))
                        rki.SetStringValue(NULL, LENS_GUID_KEY);
                } else {
                    TCHAR currentGuid[256] = {0};
                    ULONG len = 256;
            ...
            const LPCTSTR extDocExts[] = {
                LENS_DJVUTH_KEY, _T("SOFTWARE\\Classes\\.CHM\\shellex\\{BB2E617C-0920-11d1-9A0B-00C04FC2D6C1}"),
            ...
            const LPCTSTR extDocInfoTips[] = {
                LENS_DJVUIH_KEY, _T("SOFTWARE\\Classes\\.CHM\\shellex\\{00021500-0000-0000-C000-000000000046}"),
            ...
            for (int i = 0; i < _countof(extDocExts); i++) {
                if (bSet) {
                    ...
                    CRegKey rkt, rki;
                    if (ERROR_SUCCESS
                        == rkt.Create(HKEY_CURRENT_USER, extDocExts[i], NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE))
                        rkt.SetStringValue(NULL, LENS_GUID_KEY);
                    if (ERROR_SUCCESS
                        == rki.Create(HKEY_CURRENT_USER, extDocInfoTips[i], NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE))
                        rki.SetStringValue(NULL, LENS_GUID_KEY);
                } else {
                    TCHAR currentGuid[256] = {0};
                    ULONG len = 256;
        ...
        if (bSet) {
            ...
            CRegKey rkt, rki;
            if (ERROR_SUCCESS
                == rkt.Create(HKEY_CURRENT_USER, GetTHKeyName(LENSTYPE), NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE))
                rkt.SetStringValue(NULL, LENS_GUID_KEY);
            // infotip
            if (ERROR_SUCCESS
                == rki.Create(HKEY_CURRENT_USER, GetIHKeyName(LENSTYPE), NULL, REG_OPTION_NON_VOLATILE, KEY_WRITE))
                rki.SetStringValue(NULL, LENS_GUID_KEY);
        } else {
            // Smart uninstall - only remove if it's our handler
            TCHAR currentGuid[256] = {0};
