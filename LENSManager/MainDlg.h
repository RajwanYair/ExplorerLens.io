...
class CMainDlg
    ...
    , public CDialogDrag<CMainDlg>
    , public CMessageFilter
    , public CIdleHandler
    , public CSnapWindow<CMainDlg>
    , public CDialogHelp<CMainDlg>
{
  public:
    enum {
        IDD = IDD_MAINDLG
    ...
    void OnSelectAll();
    void OnDeselectAll();
    LRESULT OnSelectAllBtn(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/)
    {
        OnSelectAll();
        return 0;
    }
    LRESULT OnDeselectAllBtn(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/)
    {
        OnDeselectAll();
        return 0;
    }
