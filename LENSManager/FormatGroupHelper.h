...
inline const FormatGroup FORMAT_GROUPS[] = {
    {FormatCategory::ARCHIVES, L"Archives", L"ZIP, RAR, 7z, TAR, compressed archives"},
    {FormatCategory::COMIC_BOOKS, L"Comic Books", L"CBZ, CBR, CB7, CBT comic archives"},
    {FormatCategory::EBOOKS, L"eBooks", L"EPUB, MOBI, FB2, AZW Kindle books"},
    {FormatCategory::MODERN_IMAGES, L"Modern Images", L"WebP, AVIF, HEIC, JPEG XL, SVG"},
    {FormatCategory::RAW_IMAGES, L"Camera RAW", L"DNG, CR2, NEF, ARW raw files"},
    {FormatCategory::LEGACY_IMAGES, L"Classic Images", L"BMP, GIF, TGA, PCX, ICO, WMF"},
    {FormatCategory::HDR_IMAGES, L"HDR Images", L"EXR, HDR high dynamic range"},
    {FormatCategory::PROFESSIONAL, L"Professional", L"PSD, JPEG 2000, DDS textures"},
...
constexpr size_t FORMAT_GROUP_COUNT = static_cast<size_t>(FormatCategory::COUNT);
...
inline std::vector<const FormatEntry*> GetFormatsInGroup(const FormatEntry* entries, size_t count, FormatCategory cat)
{
