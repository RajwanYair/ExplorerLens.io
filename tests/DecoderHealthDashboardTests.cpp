...
TEST(Health, CircuitStateName_Coverage) {
...
TEST(Health, HealthStatusName_Coverage) {
...
TEST(Health, Dashboard_RegisterDecoder) {
...
TEST(Health, Dashboard_RecordSuccess) {
    auto d = DecoderHealthDashboard::Create();
...
TEST(Health, Dashboard_CircuitTrips) {
    DashboardConfig cfg;
...
TEST(Health, Dashboard_Recovery) {
    DashboardConfig cfg;
...
TEST(Health, Dashboard_GetStats) {
    auto d = DecoderHealthDashboard::Create();
...
TEST(Health, Dashboard_DisableDecoder) {
    auto d = DecoderHealthDashboard::Create();
...
TEST(Health, Dashboard_HealthPercentage) {
    auto d = DecoderHealthDashboard::Create();
    d.RegisterDecoder("A"); d.RegisterDecoder("B");
