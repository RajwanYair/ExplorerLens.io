...
TEST(VersionDrift, SemanticVersion_Parse_Standard) {
...
TEST(VersionDrift, SemanticVersion_Parse_PreRelease) {
...
TEST(VersionDrift, SemanticVersion_Parse_BuildMeta) {
...
TEST(VersionDrift, SemanticVersion_PreReleaseLessThanRelease) {
...
TEST(VersionDrift, GateCreate_Canonical) {
    auto gate = VersionDriftGate::Create("7.1.0");
...
TEST(VersionDrift, GateCreate_InitializesStalePatterns) {
    auto gate = VersionDriftGate::Create("7.1.0");
...
TEST(VersionDrift, RegisterSource_SourceCount) {
    auto gate = VersionDriftGate::Create("7.1.0");
...
TEST(VersionDrift, Validate_AllClean) {
    auto gate = VersionDriftGate::Create("7.1.0");
...
TEST(VersionDrift, Validate_DetectsDrift) {
    auto gate = VersionDriftGate::Create("7.1.0");
...
TEST(VersionDrift, Validate_Compliance) {
    auto gate = VersionDriftGate::Create("7.1.0");
...
TEST(VersionDrift, GateCheck_PassesStrict) {
    auto gate = VersionDriftGate::Create("7.1.0");
    gate.RegisterSource("README.md", "7.1.0");
...
TEST(VersionDrift, GateCheck_FailsOnMajorDrift) {
    auto gate = VersionDriftGate::Create("7.1.0");
...
TEST(VersionDrift, GateCheck_PermissiveAllowsModerate) {
    auto gate = VersionDriftGate::Create("7.1.0");
...
TEST(VersionDrift, GatePolicies_StrictConfig) {
...
TEST(VersionDrift, DriftReport_SeverityText) {
    DriftReport r;
...
TEST(VersionDrift, DriftReport_CompliancePercent_AllClean) {
    DriftReport r;
...
TEST(VersionDrift, DriftReport_CompliancePercent_NoRefs) {
    DriftReport r;
    r.totalReferences = 0;
    r.staleReferences = 0;
    EXPECT_DOUBLE_EQ(r.CompliancePercent(), 100.0);
