...
TEST(Sprint138_Compat, Execution_NotFullPass) {
    CompatTestExecution exec;
    exec.result = CompatResult::Pass;
    exec.comRegistrationOk = true;
