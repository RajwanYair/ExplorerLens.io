...
TEST(DarkMode, Manager_SwitchMode) {
    auto mgr = DarkModeManagerV2::Create(ThemeMode::Dark);
...
TEST(DarkMode, Manager_CustomPalette) {
    auto mgr = DarkModeManagerV2::Create();
    ThemePalette custom;
...
TEST(DarkMode, AllControlTypesSupported) {
