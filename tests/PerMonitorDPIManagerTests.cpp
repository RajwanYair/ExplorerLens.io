...
TEST(DPI, Manager_RegisterMonitor) {
...
TEST(DPI, Manager_GetMonitorDPI) {
    auto mgr = PerMonitorDPIManager::Create();
...
TEST(DPI, Manager_HandleDPIChange) {
    auto mgr = PerMonitorDPIManager::Create();
...
TEST(DPI, Manager_ScaleFont_Clamped) {
    DPIConfig cfg;
