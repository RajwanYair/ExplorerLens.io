...
TEST(Sprint133_JP2, Extensions_CaseInsensitive) {
    EXPECT_TRUE(JP2Extensions::IsSupported(".JP2"));
    EXPECT_TRUE(JP2Extensions::IsSupported(".J2K"));
}
TEST(Sprint133_JP2, ClassifyExtension) {
...
TEST(Sprint133_JP2, ImageInfo_EstimateSize) {
    JP2ImageInfo info;
...
TEST(Sprint133_JP2, StaticExtCheck) {
