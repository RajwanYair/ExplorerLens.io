// =============================================================================
// Sprint 32: Performance Polish & Optimization Tests
// =============================================================================
...
TEST(PerformanceTargetsTest, PerformancePolishHeaderExists) {
    namespace fs = std::filesystem;
    bool exists = fs::exists("Engine/Utils/PerformancePolish.h") ||
                  fs::exists("Engine\\Utils\\PerformancePolish.h");
    EXPECT_TRUE(exists) << "PerformancePolish.h must exist for Sprint 32";
}
