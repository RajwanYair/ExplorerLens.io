...
TEST(PluginE2E, LifecycleTransition_Valid) {
...
TEST(PluginE2E, LifecycleTransition_Invalid) {
    auto v = PluginRuntimeValidator::Create();
...
TEST(PluginE2E, IPCMessage_Latency) {
    IPCMessage msg;
...
TEST(PluginE2E, PluginCapability_Defaults) {
