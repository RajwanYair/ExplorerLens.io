...
OutputBaseFilename=DarkThumbs-v{#MyAppVersion}-x64-Setup
...
; Visual settings
SetupIconFile=..\CBXManager\CBXManager.ico
...
Source: "..\x64\Release\CBXShell.dll"; DestDir: "{sys}"; Flags: ignoreversion restartreplace uninsrestartdelete
...
Name: "{autodesktop}\DarkThumbs Config"; Filename: "{app}\{#MyAppExeName}"; Tasks: desktopicon
...
Filename: "regsvr32.exe"; Parameters: "/s ""{sys}\CBXShell.dll"""; StatusMsg: "Registering COM component..."; Flags: runhidden waituntilterminated
...
Filename: "regsvr32.exe"; Parameters: "/s /u ""{sys}\CBXShell.dll"""; StatusMsg: "Unregistering COM component..."; Flags: runhidden waituntilterminated
...
begin
  ...
  if FileExists(ExpandConstant('{sys}\CBXShell.dll')) then
  begin
    Exec('regsvr32.exe', '/s /u "' + ExpandConstant('{sys}\CBXShell.dll') + '"', '', 
