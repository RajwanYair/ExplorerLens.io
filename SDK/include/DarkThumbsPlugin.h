/**
 * DarkThumbsPlugin.h - Official DarkThumbs Plugin SDK
 * Version: 1.0.0
 * ABI Version: 1
 * 
 ...
 * 
 * This is the stable ABI for DarkThumbs thumbnail decoder plugins.
...
typedef struct DT_PluginInfo {
    ...
    const wchar_t* id;             ///< Unique stable ID (e.g., "darkthumbs.plugin.psd")
