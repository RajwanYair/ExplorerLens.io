...
// Suppress C4505: static test functions generated by TEST() macro are
// intentionally defined but not called from this translation unit — they
// register via macro expansion.
#ifdef _MSC_VER
