...
using RegressionProgressFn = std::function<void(const std::string& format, uint32_t current, uint32_t total)>;
...
class RegressionTestSuite
{
  public:
    ...
    const RegressionRunSummary& LastResult() const noexcept
    {
        return m_last;
    }
