...
TEST(TestSuite_CategoryNames) {
  ...
  ASSERT(std::wstring(TestSuiteExpansion::GetCategoryName(
             TestCategory::UnitTest)) == L"UnitTest");
  ASSERT(std::wstring(TestSuiteExpansion::GetCategoryName(
             TestCategory::DecoderTest)) == L"DecoderTest");
  ASSERT(std::wstring(TestSuiteExpansion::GetCategoryName(
             TestCategory::FuzzTest)) == L"FuzzTest");
  ASSERT(std::wstring(TestSuiteExpansion::GetCategoryName(
             TestCategory::COMTest)) == L"COMTest");
}
...
TEST(TestInstallerV2_PhaseNames) {
  ASSERT(InstallerV2Manager::PhaseName(InstallPhase::Apply) != nullptr);
}
...
TEST(TestInstallerV2_PhaseCount) {
  ASSERT(InstallerV2Manager::PhaseCount() ==
         static_cast<size_t>(InstallPhase::COUNT));
}
