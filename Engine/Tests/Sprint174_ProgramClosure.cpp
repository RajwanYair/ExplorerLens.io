// Sprint 174 — Program Closure v8.3.0 — GTest
...
TEST(ProgramClosureV83, GenerateReport) {
    ...
    EXPECT_EQ(r.retrospective.totalSprints, 25u);
}
...
TEST(ProgramClosureV83, Retrospective25Sprints) {
    auto r = ProgramClosureV83Report::Create();
    EXPECT_EQ(r.retrospective.completedSprints, 25u);
}
