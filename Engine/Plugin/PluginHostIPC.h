...
class PluginHostIPC
{
  public:
    ...
    {
        switch (type) {
            case HostIPCMessageType::Handshake:
                return "Handshake";
            case HostIPCMessageType::HandshakeAck:
                return "HandshakeAck";
            case HostIPCMessageType::Heartbeat:
                return "Heartbeat";
            case HostIPCMessageType::HeartbeatAck:
                return "HeartbeatAck";
            case HostIPCMessageType::Shutdown:
                return "Shutdown";
            case HostIPCMessageType::ShutdownAck:
                return "ShutdownAck";
            case HostIPCMessageType::PluginLoad:
                return "PluginLoad";
            case HostIPCMessageType::PluginUnload:
                return "PluginUnload";
            case HostIPCMessageType::PluginStatus:
                return "PluginStatus";
            case HostIPCMessageType::DecodeRequest:
                return "DecodeRequest";
            case HostIPCMessageType::DecodeResponse:
                return "DecodeResponse";
            case HostIPCMessageType::DecodeCancel:
                return "DecodeCancel";
            case HostIPCMessageType::ErrorReport:
                return "ErrorReport";
            case HostIPCMessageType::LogMessage:
                return "LogMessage";
            case HostIPCMessageType::ConfigUpdate:
                return "ConfigUpdate";
        }
        return "Unknown";
    }
    ...
    static constexpr int GetMessageTypeCount() noexcept
    {
        return 15;
    }
};
...
class COMApartmentAuditor
{
  public:
    ...
    uint32_t InterfaceCount() const noexcept
    {
        return 3;
    }
