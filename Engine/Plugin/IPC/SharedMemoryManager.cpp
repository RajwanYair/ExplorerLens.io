...
std::unique_ptr<SharedMemorySection> SharedMemoryManager::CreateForFile(
...
std::unique_ptr<SharedMemorySection> SharedMemoryManager::OpenForFile(
...
std::unique_ptr<SharedMemorySection> SharedMemoryManager::CreateForBitmap(
    uint64_t correlation_id,
...
std::unique_ptr<SharedMemorySection> SharedMemoryManager::OpenForBitmap(
    const std::string& name,
    uint64_t expected_size)
{
    auto section = std::make_unique<SharedMemorySection>();
