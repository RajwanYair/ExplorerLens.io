...
struct MessageHeader
{
    ...
    bool IsValid() const
    {
        return magic == PLUGIN_IPC_MAGIC && version == PLUGIN_IPC_VERSION && dataSize <= MAX_MESSAGE_SIZE;
    }
};
#pragma pack(pop)
...
struct ErrorResponse
{
    ...
    ErrorResponse() : errorCode(static_cast<uint32_t>(IPCErrorCode::SUCCESS)), messageLength(0) {}
};
#pragma pack(pop)
...
struct HeartbeatMessage
{
    ...
    HeartbeatMessage() : timestamp(0), processId(0) {}
};
#pragma pack(pop)
...
struct CanDecodeQuery
{
    ...
    CanDecodeQuery() : filePathLength(0), hasHeader(0), headerSize(0) {}
};
#pragma pack(pop)
...
struct CanDecodeResponse
{
    ...
    CanDecodeResponse() : canDecode(0), confidence(0) {}
};
#pragma pack(pop)
...
struct PluginInfoResponse
{
    ...
    PluginInfoResponse() : apiVersion(0), capabilities(0), extensionCount(0)
    {
...
{
    switch (type) {
        case MessageType::REQUEST_THUMBNAIL:
            return "REQUEST_THUMBNAIL";
        case MessageType::RESPONSE_THUMBNAIL:
        ...
        case MessageType::GET_PLUGIN_INFO:
            return "GET_PLUGIN_INFO";
        case MessageType::PLUGIN_INFO_RESPONSE:
            return "PLUGIN_INFO_RESPONSE";
        case MessageType::CAN_DECODE_QUERY:
            return "CAN_DECODE_QUERY";
        case MessageType::CAN_DECODE_RESPONSE:
            return "CAN_DECODE_RESPONSE";
        default:
            return "UNKNOWN";
    }
}
...
{
    switch (code) {
        case IPCErrorCode::SUCCESS:
            return "SUCCESS";
        case IPCErrorCode::INVALID_MAGIC:
            return "INVALID_MAGIC";
        case IPCErrorCode::INVALID_VERSION:
            return "INVALID_VERSION";
        case IPCErrorCode::INVALID_MESSAGE_TYPE:
            return "INVALID_MESSAGE_TYPE";
        case IPCErrorCode::MESSAGE_TOO_LARGE:
            return "MESSAGE_TOO_LARGE";
        case IPCErrorCode::MALFORMED_MESSAGE:
            return "MALFORMED_MESSAGE";
        case IPCErrorCode::PIPE_CONNECTION_FAILED:
            return "PIPE_CONNECTION_FAILED";
        case IPCErrorCode::PIPE_WRITE_FAILED:
            return "PIPE_WRITE_FAILED";
        case IPCErrorCode::PIPE_READ_FAILED:
            return "PIPE_READ_FAILED";
        case IPCErrorCode::PIPE_BROKEN:
            return "PIPE_BROKEN";
        case IPCErrorCode::REQUEST_TIMEOUT:
            return "REQUEST_TIMEOUT";
        case IPCErrorCode::HEARTBEAT_TIMEOUT:
            return "HEARTBEAT_TIMEOUT";
        case IPCErrorCode::PROCESS_SPAWN_FAILED:
            return "PROCESS_SPAWN_FAILED";
        case IPCErrorCode::PROCESS_TERMINATED:
            return "PROCESS_TERMINATED";
        case IPCErrorCode::PROCESS_CRASHED:
            return "PROCESS_CRASHED";
        case IPCErrorCode::OUT_OF_MEMORY:
            return "OUT_OF_MEMORY";
        case IPCErrorCode::RESOURCE_LIMIT_EXCEEDED:
            return "RESOURCE_LIMIT_EXCEEDED";
        case IPCErrorCode::PLUGIN_LOAD_FAILED:
            return "PLUGIN_LOAD_FAILED";
        case IPCErrorCode::PLUGIN_INIT_FAILED:
            return "PLUGIN_INIT_FAILED";
        case IPCErrorCode::PLUGIN_DECODE_FAILED:
            return "PLUGIN_DECODE_FAILED";
        case IPCErrorCode::PLUGIN_UNSUPPORTED_FORMAT:
            return "PLUGIN_UNSUPPORTED_FORMAT";
        case IPCErrorCode::SHARED_MEMORY_CREATE_FAILED:
            return "SHARED_MEMORY_CREATE_FAILED";
        case IPCErrorCode::SHARED_MEMORY_MAP_FAILED:
            return "SHARED_MEMORY_MAP_FAILED";
        case IPCErrorCode::SHARED_MEMORY_ACCESS_DENIED:
            return "SHARED_MEMORY_ACCESS_DENIED";
        default:
