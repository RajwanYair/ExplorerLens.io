//==============================================================================
// ExplorerLens Engine — Plugin SDK V2.0
...
enum class PluginSDKV2Capability : uint8_t {
  ...
  ThumbnailProvider = Decode, // compat alias
  COUNT = Batch + 1
};
...
public:
  static const wchar_t *CapabilityName(PluginSDKV2Capability c) {
    switch (c) {
    case PluginSDKV2Capability::Decode:
      return L"Decode";
    case PluginSDKV2Capability::Encode:
      return L"Encode";
    case PluginSDKV2Capability::Preview:
      return L"Preview";
    case PluginSDKV2Capability::Transform:
      return L"Transform";
    case PluginSDKV2Capability::MetadataRead:
      return L"Metadata Read";
    case PluginSDKV2Capability::Batch:
      return L"Batch";
    default:
      return L"Unknown";
    }
  ...
  static const wchar_t *LifeCycleName(PluginSDKV2LifeCycle l) {
    switch (l) {
    case PluginSDKV2LifeCycle::Unloaded:
      return L"Unloaded";
    case PluginSDKV2LifeCycle::Loading:
      return L"Loading";
    case PluginSDKV2LifeCycle::Active:
      return L"Active";
    case PluginSDKV2LifeCycle::Suspended:
      return L"Suspended";
    case PluginSDKV2LifeCycle::Unloading:
      return L"Unloading";
    case PluginSDKV2LifeCycle::Failed:
      return L"Failed";
    default:
      return L"Unknown";
    }
  ...
  static const wchar_t *APIVersionName(PluginAPIVersion v) {
    switch (v) {
    case PluginAPIVersion::V1_0:
      return L"1.0";
    case PluginAPIVersion::V1_5:
      return L"1.5";
    case PluginAPIVersion::V2_0:
      return L"2.0";
    default:
      return L"Unknown";
    }
  ...
  static constexpr size_t CapabilityCount() {
    return static_cast<size_t>(PluginSDKV2Capability::COUNT);
  }
  static constexpr size_t LifeCycleCount() {
    return static_cast<size_t>(PluginSDKV2LifeCycle::COUNT);
  }
  static constexpr size_t APIVersionCount() {
    return static_cast<size_t>(PluginAPIVersion::COUNT);
  }
};
