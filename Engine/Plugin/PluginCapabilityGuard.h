...
inline const wchar_t* CapabilityName(PluginCapability cap) {
    switch (cap) {
        case PluginCapability::ReadFile:     return L"ReadFile";
        case PluginCapability::WriteFile:    return L"WriteFile";
        case PluginCapability::Network:      return L"Network";
        case PluginCapability::GPU:          return L"GPU";
        case PluginCapability::Memory:       return L"Memory";
        case PluginCapability::Registry:     return L"Registry";
        case PluginCapability::ProcessSpawn: return L"ProcessSpawn";
        case PluginCapability::All:          return L"All";
        case PluginCapability::None:         return L"None";
...
public:
    ...
    PluginCapability GetRaw() const { return m_capabilities; }
    ...
    void Clear() { m_capabilities = PluginCapability::None; }
    bool IsEmpty() const { return m_capabilities == PluginCapability::None; }
...
public:
    CapabilityGuard(const CapabilitySet& caps,
                    PluginCapability required,
                    const std::wstring& pluginId = L"",
    ...
    bool IsGranted() const { return m_granted; }
    explicit operator bool() const { return m_granted; }
    ...
    public:
        ...
        std::vector<CapabilityCheckRecord> GetDeniedRecords() const {
            ...
            for (auto& r : m_records) {
                if (!r.granted) denied.push_back(r);
            }
            return denied;
        }
