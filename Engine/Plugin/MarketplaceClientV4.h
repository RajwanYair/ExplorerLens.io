...
class MarketplaceClientV4
{
  public:
    ...
    [[nodiscard]] std::string Download(const std::string& pluginId, const std::string& destDirectory,
    ...
    [[nodiscard]] CachePolicy GetCachePolicy() const noexcept
    {
        return m_cachePolicy;
    }
    [[nodiscard]] MarketplaceProtocol GetProtocol() const noexcept
    {
        return m_protocol;
    }
