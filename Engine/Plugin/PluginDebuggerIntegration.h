...
class PluginDebuggerIntegration
{
  public:
    ...
    {
        switch (m) {
            case PluginDebugMode::Attach:
                return L"Attach";
            case PluginDebugMode::Detach:
                return L"Detach";
            case PluginDebugMode::StepThrough:
                return L"Step-Through";
            case PluginDebugMode::Inspect:
                return L"Inspect";
            default:
                return L"Unknown";
        }
    ...
    static const wchar_t* EventName(PluginDebugEvent e) noexcept
    {
        switch (e) {
            ...
            case PluginDebugEvent::Unload:
                return L"Unload";
            case PluginDebugEvent::Crash:
                return L"Crash";
            case PluginDebugEvent::Freeze:
                return L"Freeze";
