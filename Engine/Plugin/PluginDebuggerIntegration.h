//==============================================================================
// DarkThumbs Engine — Sprint 311: Plugin Debugger Integration
...
enum class PluginLogLevel : uint8_t {
    Trace = 0, Debug, Info, Warning, Error, Fatal, COUNT
};

enum class PluginDebugEvent : uint8_t {
    Load = 0, Decode, MemAlloc, Timeout, Fault, Unload, COUNT
};
...
public:
    static const wchar_t* DebugModeName(PluginDebugMode m) {
        switch (m) {
            case PluginDebugMode::Disabled:      return L"Disabled";
            case PluginDebugMode::LogOnly:       return L"Log Only";
            case PluginDebugMode::AttachOnFault: return L"Attach On Fault";
            case PluginDebugMode::AlwaysAttach:  return L"Always Attach";
    ...
    static const wchar_t* LogLevelName(PluginLogLevel l) {
        switch (l) {
            case PluginLogLevel::Trace:   return L"TRACE";
            case PluginLogLevel::Debug:   return L"DEBUG";
            case PluginLogLevel::Info:    return L"INFO";
            case PluginLogLevel::Warning: return L"WARN";
    ...
    static const wchar_t* DebugEventName(PluginDebugEvent e) {
        switch (e) {
            ...
            case PluginDebugEvent::Decode:   return L"Decode";
            case PluginDebugEvent::MemAlloc: return L"MemAlloc";
            case PluginDebugEvent::Timeout:  return L"Timeout";
            case PluginDebugEvent::Fault:    return L"Fault";
            case PluginDebugEvent::Unload:   return L"Unload";
            default: return L"Unknown";
        }
    }

    static constexpr size_t DebugModeCount()  { return static_cast<size_t>(PluginDebugMode::COUNT); }
    static constexpr size_t LogLevelCount()   { return static_cast<size_t>(PluginLogLevel::COUNT); }
    static constexpr size_t DebugEventCount() { return static_cast<size_t>(PluginDebugEvent::COUNT); }
};
