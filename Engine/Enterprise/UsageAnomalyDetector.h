...
public:
    ...
    bool                      ResolveAnomaly(const std::string& decoderId,
                                             AnomalyType type);
    ...
    // Baseline access
    std::optional<BaselineStats> GetBaseline(const std::string& decoderId,
...
private:
    ...
    void            UpdateBaseline(const std::string& decoderId, AnomalyType type,
                                    double value);
};
