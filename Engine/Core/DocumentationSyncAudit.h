...
inline std::string ToString(DocArtifact a) {
    ...
    case DocArtifact::ReleaseDoc: return "docs/development/README.md";
...
struct DocSyncAuditResult {
    ...
    static DocSyncAuditResult CreateMock(bool allPass = true) {
        ...
        addCheck(SyncCheckId::MilestoneCountConsistent,
        ...
        addCheck(SyncCheckId::CopilotInstructionsSync,
            DocArtifact::CopilotInstructions, allPass, "", allPass ? "" : "");
        addCheck(SyncCheckId::AllReleaseDocsPresent,
            DocArtifact::ReleaseDoc, true, "25 docs", "25 docs");
