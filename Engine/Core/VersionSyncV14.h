...
struct V14DomainDescriptor {
    ...
    uint32_t        sprintStart = 0;
    uint32_t        sprintEnd   = 0;
    std::wstring    title;
};
...
public:
    static const wchar_t* DomainName(V14Domain d) {
        switch (d) {
            case V14Domain::GPUPipelineV3:        return L"GPU Pipeline V3";
            case V14Domain::FormatIntelligence:   return L"Format Intelligence";
            case V14Domain::DeveloperExperience:  return L"Developer Experience";
            case V14Domain::SecurityExcellence:   return L"Security Excellence";
            case V14Domain::UXExcellence:         return L"UX Excellence";
            case V14Domain::AIMLExpansion:        return L"AI/ML Expansion";
            case V14Domain::EnterpriseCloudV2:    return L"Enterprise & Cloud V2";
            case V14Domain::PlatformHardening:    return L"Platform Hardening";
            case V14Domain::PerformanceSummit:    return L"Performance Summit";
            case V14Domain::ReleaseGate:          return L"Release Gate";
    ...
    static const wchar_t* FeatureStatusName(FeatureStatus s) {
        switch (s) {
            case FeatureStatus::Planned:     return L"Planned";
            case FeatureStatus::InProgress:  return L"In Progress";
            case FeatureStatus::Implemented: return L"Implemented";
            case FeatureStatus::Deprecated:  return L"Deprecated";
            default: return L"Unknown";
        }
    }

    static constexpr size_t DomainCount() { return static_cast<size_t>(V14Domain::COUNT); }
    static constexpr size_t FeatureStatusCount() { return static_cast<size_t>(FeatureStatus::COUNT); }
