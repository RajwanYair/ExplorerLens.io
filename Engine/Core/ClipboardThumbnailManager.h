...
inline const char* ClipboardFormatName(ClipboardFormat f) noexcept
{
    switch (f) {
        case ClipboardFormat::PNG:
            return "PNG";
        case ClipboardFormat::JPEG:
            return "JPEG";
        case ClipboardFormat::DIB:
            return "DIB";
        case ClipboardFormat::EnhMetafile:
            return "EnhMetafile";
        case ClipboardFormat::CustomFormat:
            return "CustomFormat";
        default:
            return "Unknown";
    }
...
{
    switch (t) {
        case PasteTarget::Explorer:
            return "Explorer";
        case PasteTarget::Desktop:
            return "Desktop";
        case PasteTarget::Application:
            return "Application";
        case PasteTarget::Email:
            return "Email";
        case PasteTarget::Document:
            return "Document";
        default:
            return "Unknown";
    }
...
class ClipboardThumbnailManager
{
  public:
    ...
    uint64_t GetCopyCount() const noexcept
    {
        return m_copyCount;
    }
