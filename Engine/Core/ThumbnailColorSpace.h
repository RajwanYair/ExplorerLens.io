...
{
    switch (g) {
        case GammaMapping::Linear:
            return "Linear";
        case GammaMapping::Gamma22:
            return "Gamma2.2";
        case GammaMapping::PQ:
            return "PQ";
        case GammaMapping::HLG:
            return "HLG";
        default:
            return "Unknown";
    }
...
{
  public:
    void SetWorkingSpace(ColorSpaceType type) noexcept
    {
        m_profile.colorSpace = type;
    }
    const ColorProfile& GetProfile() const noexcept
    {
        return m_profile;
    }
