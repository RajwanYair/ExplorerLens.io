...
struct EngineError {
    ...
    static EngineError Make(
        DecodeErrorCategory cat,
        std::string msg,
    ...
    long ToHResult() const noexcept {
        switch (category) {
        case DecodeErrorCategory::None:              return 0;
        case DecodeErrorCategory::FormatUnsupported: return static_cast<long>(0x80040201);
        case DecodeErrorCategory::DecoderNotFound:   return static_cast<long>(0x80040202);
        case DecodeErrorCategory::FileNotFound:      return static_cast<long>(0x80070002);
        case DecodeErrorCategory::AccessDenied:      return static_cast<long>(0x80070005);
        case DecodeErrorCategory::OutOfMemory:       return static_cast<long>(0x8007000E);
        case DecodeErrorCategory::Timeout:           return static_cast<long>(0x80070102);
        default:                                     return static_cast<long>(0x80004005);
        }
    }

    bool IsRetryable() const noexcept {
        return category == DecodeErrorCategory::GPUDeviceLost
            || category == DecodeErrorCategory::Timeout
...
[[nodiscard]] Result<T, EngineError> DecodeErr(
    DecodeErrorCategory cat,
    std::string msg,
    std::source_location loc = std::source_location::current()) {
...
[[nodiscard]] inline VoidDecodeResult FromHResult(long hr) {
    if (hr >= 0) return VoidDecodeResult(OkTag{});
    EngineError e;
