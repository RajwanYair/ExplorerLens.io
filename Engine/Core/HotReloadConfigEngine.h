...
inline const char* HotReloadSourceName(HotReloadSource value) {
    switch (value) {
    case HotReloadSource::Registry:    return "Registry";
    case HotReloadSource::File:        return "File";
    case HotReloadSource::Environment: return "Environment";
    case HotReloadSource::Default:     return "Default";
    case HotReloadSource::Remote:      return "Remote";
...
inline const char* ConfigReloadTriggerName(ConfigReloadTrigger value) {
    switch (value) {
    case ConfigReloadTrigger::Manual:         return "Manual";
    case ConfigReloadTrigger::Timer:          return "Timer";
    case ConfigReloadTrigger::FileChange:     return "FileChange";
    case ConfigReloadTrigger::RegistryChange: return "RegistryChange";
    case ConfigReloadTrigger::Signal:         return "Signal";
    default:                            return "Unknown";
    }
}
...
struct HotReloadResult {
    ...
    bool HasChanges() const { return !changedKeys.empty(); }
};
