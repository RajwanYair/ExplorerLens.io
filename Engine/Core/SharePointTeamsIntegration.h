...
enum class CloudFileSource : uint8_t {
    SharePoint = 0,
    OneDrive,
    Teams,
    Yammer,
...
enum class GraphAuthMethod : uint8_t {
    DeviceCode = 0,
    ClientCredential,
    ManagedIdentity,
    InteractiveMSAL,
...
class SharePointTeamsIntegration
{
  public:
    ...
    {
        switch (s) {
            case CloudFileSource::SharePoint:
                return L"SharePoint";
            case CloudFileSource::OneDrive:
                return L"OneDrive";
            case CloudFileSource::Teams:
                return L"Microsoft Teams";
            case CloudFileSource::Yammer:
                return L"Viva Engage";
            default:
                return L"Unknown";
        }
    }
    ...
    {
        switch (a) {
            case GraphAuthMethod::DeviceCode:
                return L"Device Code";
            case GraphAuthMethod::ClientCredential:
                return L"Client Credential";
            case GraphAuthMethod::ManagedIdentity:
                return L"Managed Identity";
            case GraphAuthMethod::InteractiveMSAL:
                return L"Interactive MSAL";
            default:
                return L"Unknown";
        }
    }
    static const wchar_t* SyncStateName(CloudSyncState s)
    {
        switch (s) {
            ...
            case CloudSyncState::Error:
                return L"Error";
            case CloudSyncState::Throttled:
                return L"Throttled";
            default:
                return L"Unknown";
        }
    }
    static constexpr size_t CloudSourceCount()
    {
        return static_cast<size_t>(CloudFileSource::COUNT);
    }
    static constexpr size_t AuthMethodCount()
    {
        return static_cast<size_t>(GraphAuthMethod::COUNT);
    }
    static constexpr size_t SyncStateCount()
    {
        return static_cast<size_t>(CloudSyncState::COUNT);
    }
};
