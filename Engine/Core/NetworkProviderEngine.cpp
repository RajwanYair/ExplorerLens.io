...
NetworkThumbnailResult NetworkProviderEngine::FetchThumbnail(const std::wstring& networkPath)
{
...
NetworkStatus NetworkProviderEngine::CheckConnectivity(const std::wstring& /*server*/) const
{
...
{
    switch (protocol) {
        case ProviderNetProtocol::UNC:
            return L"UNC";
        case ProviderNetProtocol::SMB:
            return L"SMB";
        case ProviderNetProtocol::WebDAV:
            return L"WebDAV";
        case ProviderNetProtocol::FTP:
            return L"FTP";
        case ProviderNetProtocol::SFTP:
            return L"SFTP";
        case ProviderNetProtocol::HTTP:
            return L"HTTP";
        default:
            return L"Unknown";
    }
...
const wchar_t* NetworkProviderEngine::GetStatusName(NetworkStatus status)
{
    switch (status) {
        ...
        case NetworkStatus::Timeout:
            return L"Timeout";
        case NetworkStatus::AuthRequired:
