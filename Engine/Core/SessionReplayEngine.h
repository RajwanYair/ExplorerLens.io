...
class SessionReplayEngine
{
  public:
    ...
    void SetFrameCallback(ReplayFrameCallback cb)
    {
    ...
    ReplayRecording StopRecording()
    {
        ...
        m_current.durationMs =
            m_current.frames.empty() ? 0 : m_current.frames.back().timestampMs - m_current.frames.front().timestampMs;
        return m_current;
    }
    ...
    ReplayState GetState() const noexcept
    {
        return m_state;
    }
    ...
    {
        switch (s) {
            case ReplaySpeed::Slow_0_25x:
                return 0.25;
            case ReplaySpeed::Normal_1x:
                return 1.0;
            case ReplaySpeed::Fast_2x:
                return 2.0;
            case ReplaySpeed::Super_4x:
                return 4.0;
        }
        return 1.0;
    }
