...
#define AUDIT_LOG(id, sev, msg, detail)                                                                  \
    ::ExplorerLens::Engine::AuditLogger::Instance().Log({::ExplorerLens::Engine::AuditEventId::id,       \
...
class AuditTrailLogger
{
  public:
    ...
    {
        static const wchar_t* names[] = {L"Debug", L"Info", L"Warning", L"Error", L"Critical"};
