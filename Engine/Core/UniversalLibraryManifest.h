...
inline const char* SPDXLicenseToString(SPDXLicense lic)
{
    switch (lic) {
        case SPDXLicense::MIT:
            return "MIT";
        case SPDXLicense::Apache2:
            return "Apache-2.0";
        case SPDXLicense::BSD3:
            return "BSD-3-Clause";
        case SPDXLicense::LGPL21:
            return "LGPL-2.1-only";
        case SPDXLicense::Zlib:
            return "Zlib";
        case SPDXLicense::MPL2:
            return "MPL-2.0";
        case SPDXLicense::ISC:
            return "ISC";
        case SPDXLicense::BSL1:
            return "BSL-1.0";
        case SPDXLicense::Custom:
...
{
  public:
    UniversalLibraryManifest() : m_includeDevDeps(false)
    {
    ...
    bool ValidateCompleteness() const
    {
        for (const auto& lib : m_libraries) {
            if (lib.name.empty() || lib.version.empty())
                return false;
            if (lib.license == SPDXLicense::Unknown)
                return false;
        }
        return true;
    }

    void AddLibrary(ThirdPartyLib lib)
    {
    ...
    void SetIncludeDevDeps(bool include)
    {
        m_includeDevDeps = include;
    }
