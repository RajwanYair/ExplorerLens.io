...
{
  public:
    void Configure(const HDRMapperConfig& cfg)
    {
        m_config = cfg;
    }
    const HDRMapperConfig& GetConfig() const
    {
        return m_config;
    }
    ...
    static size_t OperatorCount()
    {
        return static_cast<size_t>(HDRToneMappingOp::COUNT);
    }
    static size_t FormatCount()
    {
        return static_cast<size_t>(HDRSourceFormat::COUNT);
    }
