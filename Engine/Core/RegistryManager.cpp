...
const wchar_t* RegistryManager::GetHiveName(RegHive hive) {
    switch (hive) {
        case RegHive::HKCU: return L"HKCU";
        case RegHive::HKLM: return L"HKLM";
        case RegHive::HKCR: return L"HKCR";
...
const wchar_t* RegistryManager::GetValueTypeName(RegValueType type) {
    switch (type) {
        case RegValueType::String:  return L"REG_SZ";
        case RegValueType::DWord:   return L"REG_DWORD";
        case RegValueType::QWord:   return L"REG_QWORD";
        case RegValueType::Binary:  return L"REG_BINARY";
        case RegValueType::MultiSz: return L"REG_MULTI_SZ";
        default:                    return L"Unknown";
    }
}
...
bool RegistryManager::WriteString(RegHive hive, const std::wstring& key,
...
std::wstring RegistryManager::ReadString(RegHive hive, const std::wstring& key,
                                          const std::wstring& name, const std::wstring& defaultVal) const {
