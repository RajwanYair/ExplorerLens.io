...
enum class MSIXInstallState { NotStarted, Streaming, ContentGroupReady, Complete, Failed };
...
public:
    ...
    void SetGroupReadyCallback(MSIXGroupReadyCallback cb) { m_callback = std::move(cb); }
    ...
    MSIXStreamingStats GetStats() const noexcept { return m_stats; }
