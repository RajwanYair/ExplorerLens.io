...
enum class VolumeRenderMode { MaxIntensityProjection, RayCasting, SummedVoxelProjection };
enum class VolumeFormat     { OpenVDB, DICOM, NIfTI, RAW };
...
public:
    ...
    static std::string FormatName(VolumeFormat fmt) noexcept {
        switch (fmt) {
        case VolumeFormat::OpenVDB: return "OpenVDB";
        case VolumeFormat::DICOM:   return "DICOM";
        case VolumeFormat::NIfTI:   return "NIfTI";
        case VolumeFormat::RAW:     return "RAW";
        }
        return "Unknown";
    }
    ...
    static std::string ModeName(VolumeRenderMode mode) noexcept {
        switch (mode) {
        case VolumeRenderMode::MaxIntensityProjection:  return "MIP";
        case VolumeRenderMode::RayCasting:              return "RayCasting";
        case VolumeRenderMode::SummedVoxelProjection:   return "SVP";
        }
        return "Unknown";
    }
};
