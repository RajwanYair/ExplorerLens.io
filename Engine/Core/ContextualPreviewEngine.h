...
public:
    ...
    ContextualPreviewEngineConfig GetConfig() const { return m_config; }
    std::string GetName() const { return m_config.label; }

    enum class ViewMode : uint8_t {
        SmallIcons, MediumIcons, LargeIcons, ExtraLargeIcons,
        Tiles, Details, Content, List
    };
    ...
    QualityParams GetParamsForView(ViewMode mode) const {
        QualityParams p;
        switch (mode) {
        case ViewMode::SmallIcons:      p = { 48, false, false, 70 }; break;
        case ViewMode::MediumIcons:     p = { 96, false, false, 75 }; break;
        case ViewMode::LargeIcons:      p = { 256, true, false, 85 }; break;
        case ViewMode::ExtraLargeIcons: p = { 512, true, true, 90 }; break;
        case ViewMode::Tiles:           p = { 128, true, false, 80 }; break;
        case ViewMode::Details:         p = { 32, false, false, 65 }; break;
        case ViewMode::Content:         p = { 128, true, false, 80 }; break;
        case ViewMode::List:            p = { 16, false, false, 60 }; break;
        }
        return p;
    }
