...
{
    switch (t) {
        case AccessTokenType::Process:
            return "Process";
        case AccessTokenType::Thread:
            return "Thread";
        case AccessTokenType::Impersonation:
            return "Impersonation";
        case AccessTokenType::Restricted:
            return "Restricted";
        case AccessTokenType::Anonymous:
            return "Anonymous";
        default:
            return "Unknown";
    }
...
inline const char* TokenValidationResultName(TokenValidationResult r) noexcept
{
    switch (r) {
        ...
        case TokenValidationResult::Expired:
            return "Expired";
        case TokenValidationResult::Revoked:
            return "Revoked";
        case TokenValidationResult::InsufficientPriv:
...
class AccessTokenValidator
{
  public:
    ...
    uint64_t GetValidationCount() const noexcept
    {
