...
enum class QSKEScheme { MLKEM768_X25519, MLKEM1024_P384 };
...
public:
    ...
    std::pair<QSKEHandshakeMessage, QSKESessionKeys>
    ProcessClientHello(const QSKEHandshakeMessage& clientHello) const {
