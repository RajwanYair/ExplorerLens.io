...
public:
    static const wchar_t* EnhancementName(AIEnhancement e) {
        switch (e) {
            case AIEnhancement::SuperResolution:  return L"Super Resolution";
            case AIEnhancement::AutoCrop:         return L"Auto Crop";
            case AIEnhancement::SaliencyDetection:return L"Saliency Detection";
            case AIEnhancement::NoiseReduction:   return L"Noise Reduction";
            case AIEnhancement::ColorCorrection:  return L"Color Correction";
            case AIEnhancement::FaceDetection:    return L"Face Detection";
            case AIEnhancement::TextEnhance:      return L"Text Enhance";
    ...
    static const wchar_t* BackendName(AIModelBackend b) {
        switch (b) {
            case AIModelBackend::DirectML:     return L"DirectML";
            case AIModelBackend::ONNX:         return L"ONNX Runtime";
            case AIModelBackend::OpenVINO:     return L"OpenVINO";
            case AIModelBackend::CPUFallback:  return L"CPU Fallback";
            default: return L"Unknown";
        }
    }

    static constexpr size_t EnhancementCount() { return static_cast<size_t>(AIEnhancement::COUNT); }
    static constexpr size_t BackendCount() { return static_cast<size_t>(AIModelBackend::COUNT); }
