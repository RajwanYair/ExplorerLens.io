...
enum class ImmersiveRenderQuality { Draft, Standard, High, UltraRT };
enum class ImmersiveRenderBackend { DirectX12, Vulkan, CPU };
...
public:
    ...
    ImmersiveRenderBackend GetBackend() const noexcept { return m_backend; }

    static std::string QualityName(ImmersiveRenderQuality q) noexcept {
        switch (q) {
        case ImmersiveRenderQuality::Draft:    return "Draft";
        case ImmersiveRenderQuality::Standard: return "Standard";
        case ImmersiveRenderQuality::High:     return "High";
        case ImmersiveRenderQuality::UltraRT:  return "UltraRT";
        }
        return "Unknown";
    }
...
private:
    static double qualityMs(ImmersiveRenderQuality q) noexcept {
        switch (q) {
        case ImmersiveRenderQuality::Draft:    return 5.0;
        case ImmersiveRenderQuality::Standard: return 17.0;
        case ImmersiveRenderQuality::High:     return 80.0;
        case ImmersiveRenderQuality::UltraRT:  return 500.0;
        }
        return 17.0;
    }
