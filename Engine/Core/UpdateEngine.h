...
class UpdateEngine
{
  public:
    ...
    {
        return static_cast<uint32_t>(EngineUpdateChannel::COUNT);
    }

    /// Set current version
    void SetCurrentVersion(const std::wstring& ver)
    {
    ...
    /// Set update channel
    void SetChannel(EngineUpdateChannel ch)
    {
        m_channel = ch;
    }
    EngineUpdateChannel GetChannel() const
    {
        return m_channel;
    }
