// SystemTrayManager.h — System Tray Icon Management (Sprint 585)
...
public:
    ...
    inline bool Initialize(HINSTANCE hInstance) {
        ...
        m_hwnd = CreateWindowExW(
            0, kWindowClass, L"ExplorerLensTray",
            0, 0, 0, 0, 0,
    ...
    inline bool AddTrayIcon(uint32_t iconId, const std::wstring& tooltip) {
        if (!m_initialized.load() || !m_hwnd) return false;
    ...
    inline bool ShowBalloon(uint32_t iconId,
    ...
    inline void SetContextMenu(uint32_t iconId,
...
private:
    ...
    static LRESULT CALLBACK TrayWndProc(HWND hwnd, UINT msg,
        ...
        auto* self = reinterpret_cast<SystemTrayManager*>(
