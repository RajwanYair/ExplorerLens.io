...
using PolicyValue = std::variant<bool, int32_t, uint32_t, std::string,
...
using PolicyChangeCallback =
    std::function<void(const EnterprisePolicyEntry& newValue, const EnterprisePolicyEntry& oldValue)>;
...
class EnterprisePolicyEngineV2
{
  public:
    ...
    {
        switch (src) {
            case EnterprisePolicySource::GroupPolicy:
                return L"Group Policy";
            case EnterprisePolicySource::Intune:
                return L"Microsoft Intune";
            case EnterprisePolicySource::ConfigMgr:
                return L"Configuration Manager";
            case EnterprisePolicySource::AdminManual:
                return L"Admin Manual";
            case EnterprisePolicySource::UserPreference:
                return L"User Preference";
            case EnterprisePolicySource::Default:
                return L"Default";
            default:
                return L"Unknown";
        }
    ...
    {
        switch (s) {
            case PolicyComplianceStatus::Compliant:
                return L"Compliant";
            case PolicyComplianceStatus::Partial:
                return L"Partial";
            case PolicyComplianceStatus::NonCompliant:
                return L"Non-Compliant";
            case PolicyComplianceStatus::Unenforced:
                return L"Unenforced";
            default:
                return L"Unknown";
        }
