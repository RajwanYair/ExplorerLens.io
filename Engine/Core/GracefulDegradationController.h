...
{
  public:
    void Configure(const DegradationConfig& cfg)
    {
        m_config = cfg;
    }
    const DegradationConfig& GetConfig() const
    {
        return m_config;
    }
    ...
    DegradationLevel GetLevel() const
    {
    ...
    bool IsFeatureAllowed(FeatureTier tier) const
    {
        switch (m_status.current) {
            case DegradationLevel::FullFeature:
                return true;
    ...
    const DegradationStatus& GetStatus() const
    {
        return m_status;
    }
    ...
    static size_t TierCount()
    {
        return static_cast<size_t>(FeatureTier::COUNT);
    }
    static size_t LevelCount()
    {
        return static_cast<size_t>(DegradationLevel::COUNT);
    }
