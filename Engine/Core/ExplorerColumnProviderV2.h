...
{
  public:
    void RegisterColumn(ColumnDef col)
    {
    ...
    const ColumnDef& GetColumn(size_t idx) const
    {
        return m_cols[idx];
    }
...
inline const ColumnDefinition* GetColumnDefinitions() noexcept
{
    static const ColumnDefinition defs[] = {
        {L"Dimensions", ColumnID::Dimensions, 100, true}, {L"Color Space", ColumnID::ColorSpace, 90, true},
        {L"Camera", ColumnID::CameraModel, 120, true},    {L"Format", ColumnID::FileFormat, 80, true},
        {L"File Size", ColumnID::FileSize, 80, true},     {L"Date Taken", ColumnID::DateTaken, 100, true},
    };
    return defs;
}
