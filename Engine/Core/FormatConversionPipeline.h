...
inline const char* ConvertTargetName(ConvertTarget t) noexcept {
    switch (t) {
    case ConvertTarget::WebP:  return "WebP";
    case ConvertTarget::AVIF:  return "AVIF";
    case ConvertTarget::JXL:   return "JXL";
    case ConvertTarget::HEIF:  return "HEIF";
    case ConvertTarget::PNG:   return "PNG";
...
inline const char* ConversionQualityName(ConversionQuality q) noexcept {
    switch (q) {
    case ConversionQuality::Lossless:    return "Lossless";
    case ConversionQuality::HighQuality: return "HighQuality";
    case ConversionQuality::Balanced:    return "Balanced";
    case ConversionQuality::FastDraft:   return "FastDraft";
    case ConversionQuality::Minimal:     return "Minimal";
    default:                             return "Unknown";
    }
}
...
public:
    ...
    bool Convert(const std::wstring& sourcePath, ConvertTarget target,
        ConversionQuality quality, FormatConversionJob& outJob) {
    ...
    uint64_t GetTotalConversions() const noexcept { return m_totalConversions; }
...
private:
    static uint64_t EstimateOutputSize(ConversionQuality q) noexcept {
        switch (q) {
        case ConversionQuality::Lossless:    return 256000;
        case ConversionQuality::HighQuality: return 128000;
        case ConversionQuality::Balanced:    return 64000;
        case ConversionQuality::FastDraft:   return 32000;
        case ConversionQuality::Minimal:     return 16000;
    ...
    static double EstimateTime(ConvertTarget t) noexcept {
        switch (t) {
        case ConvertTarget::WebP:  return 8.0;
        case ConvertTarget::AVIF:  return 45.0;
        case ConvertTarget::JXL:   return 20.0;
        case ConvertTarget::HEIF:  return 35.0;
        case ConvertTarget::PNG:   return 5.0;
        default:                   return 15.0;
        }
    }
