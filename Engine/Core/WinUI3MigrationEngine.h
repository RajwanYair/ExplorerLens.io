...
class WinUI3MigrationEngine
{
  public:
    ...
    {
        return static_cast<size_t>(PageType::COUNT);
    }

    static std::vector<MigrationStatus> GetStatus()
    {
        return {
            {PageType::FormatSettings, UIFramework::WTL, UIFramework::WinUI3, MigrationPhase::Research, 10},
            {PageType::PerformanceTab, UIFramework::WTL, UIFramework::WinUI3, MigrationPhase::Research, 5},
            {PageType::AboutPage, UIFramework::WTL, UIFramework::WinUI3, MigrationPhase::Prototype, 30},
            {PageType::PluginMarketplace, UIFramework::WTL, UIFramework::WinUI3, MigrationPhase::Research, 5},
            {PageType::DiagnosticsTab, UIFramework::WTL, UIFramework::WinUI3, MigrationPhase::Research, 5},
        };
    }
