...
{
    switch (s) {
        case RenamePreviewState::Idle:
            return "Idle";
        case RenamePreviewState::Generating:
            return "Generating";
        case RenamePreviewState::Ready:
            return "Ready";
        case RenamePreviewState::Stale:
            return "Stale";
        case RenamePreviewState::Error:
            return "Error";
        default:
            return "Unknown";
    }
...
class BatchRenamePreview
{
  public:
    ...
    bool GeneratePreviews(const std::vector<std::string>& filePaths, RenamePattern pattern,
    ...
    RenamePreviewState GetState() const
    {
        return m_state;
    }
    RenamePattern GetPattern() const
    {
        return m_pattern;
    }
  ...
  private:
    std::string ApplyPattern(const std::string& path, RenamePattern pattern, const std::string& arg,
