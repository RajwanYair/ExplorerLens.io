...
class CRTConsistencyManager
{
  public:
    ...
    static size_t CRTModeCount()
    {
        return static_cast<size_t>(CRTMode::COUNT);
    }
    ...
    static std::vector<LibraryCRT> AuditLibraries()
    {
        return {
            ...
            {L"libwebp", L"1.5.0", CRTMode::DynamicMD, LinkageStatus::Consistent},  // FIXED
            {L"minizip-ng", L"4.0.10", CRTMode::DynamicMD, LinkageStatus::Consistent},
