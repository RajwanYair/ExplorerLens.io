...
inline const char* DuplicateHashMethodName(DuplicateHashMethod m) {
    switch (m) {
    case DuplicateHashMethod::MD5:            return "MD5";
    case DuplicateHashMethod::SHA256:         return "SHA256";
    case DuplicateHashMethod::Perceptual:     return "Perceptual";
    case DuplicateHashMethod::Average:        return "Average";
    case DuplicateHashMethod::DifferenceHash: return "DifferenceHash";
...
inline const char* DuplicateConfidenceName(DuplicateConfidence c) {
    switch (c) {
    case DuplicateConfidence::Exact:    return "Exact";
    case DuplicateConfidence::VeryHigh: return "VeryHigh";
    case DuplicateConfidence::High:     return "High";
    case DuplicateConfidence::Medium:   return "Medium";
    case DuplicateConfidence::Low:      return "Low";
    default:                            return "Unknown";
    }
}
...
public:
    ...
    bool ScanDirectory(const std::string& directoryPath,
        DuplicateHashMethod method = DuplicateHashMethod::Perceptual) {
        ...
        group.confidence = (method == DuplicateHashMethod::MD5 ||
            method == DuplicateHashMethod::SHA256)
    ...
    uint64_t GetScannedFileCount() const { return m_scannedFiles; }
    bool IsScanComplete() const { return m_scanComplete; }
    DuplicateHashMethod GetMethod() const { return m_method; }
