...
enum class AnimationScrubStrategy {
    FirstFrame,
    MiddleFrame,
    MaxMotionFrame,
    SmartPose
...
class AnimationPreviewScrubber
{
  public:
    ...
    {
        switch (s) {
            case AnimationScrubStrategy::FirstFrame:
                return "FirstFrame";
            case AnimationScrubStrategy::MiddleFrame:
                return "MiddleFrame";
            case AnimationScrubStrategy::MaxMotionFrame:
                return "MaxMotionFrame";
            case AnimationScrubStrategy::SmartPose:
                return "SmartPose";
        }
        return "Unknown";
    }
