...
class GPUShaderLibrary
{
  public:
    ...
    {
        return static_cast<size_t>(ShaderType::COUNT);
    }
    ...
    {
        return {
            {ShaderType::BilinearResize, L"thumbnail_resize.hlsl", L"cs_5_0", true, 0.75f},
            {ShaderType::LanczosResize, L"lanczos_resize.hlsl", L"cs_5_0", true, 0.95f},
            {ShaderType::BicubicResize, L"bicubic_resize.hlsl", L"cs_5_0", true, 0.90f},
            {ShaderType::HDRTonemap, L"hdr_tonemap.hlsl", L"cs_5_0", true, 0.92f},
            {ShaderType::ColorConvert, L"color_convert.hlsl", L"cs_5_0", true, 0.98f},
            {ShaderType::GaussianBlur, L"gaussian_blur.hlsl", L"cs_5_0", false, 0.0f},
