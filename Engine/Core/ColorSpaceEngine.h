...
class ColorSpaceEngine
{
  public:
    ...
    {
        return {{0.8225f, 0.1774f, 0.0000f, 0.0332f, 0.9669f, 0.0000f, 0.0171f, 0.0724f, 0.9108f}};
    }

    /// Compute Delta E (CIE76) between two Lab colors
    static float DeltaE76(float L1, float a1, float b1, float L2, float a2, float b2)
    {
        float dL = L2 - L1, da = a2 - a1, db = b2 - b1;
        return sqrtf(dL * dL + da * da + db * db);
    }

    static ColorProfileInfo DefaultProfile()
    {
