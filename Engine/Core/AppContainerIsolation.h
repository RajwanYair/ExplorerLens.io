...
enum class AppContainerStatus { NotIsolated, Isolated, Denied };
...
public:
    explicit AppContainerIsolation(AppContainerPolicy policy = {})
    ...
    bool HasCapability(AppContainerCapability cap) const noexcept {
        for (auto c : m_policy.capabilities) if (c == cap) return true;
        return false;
    }

    void GrantCapability(AppContainerCapability cap)  { m_policy.capabilities.push_back(cap); }
    ...
    const AppContainerPolicy& Policy() const noexcept { return m_policy; }

    static std::string CapabilityName(AppContainerCapability cap) noexcept {
        switch (cap) {
        case AppContainerCapability::InternetClient:              return "internetClient";
        case AppContainerCapability::InternetClientServer:        return "internetClientServer";
        case AppContainerCapability::PrivateNetworkClientServer:  return "privateNetworkClientServer";
        case AppContainerCapability::PicturesLibrary:             return "picturesLibrary";
        case AppContainerCapability::VideosLibrary:               return "videosLibrary";
        case AppContainerCapability::MusicLibrary:                return "musicLibrary";
        case AppContainerCapability::DocumentsLibrary:            return "documentsLibrary";
        case AppContainerCapability::RemovableStorage:            return "removableStorage";
        case AppContainerCapability::SharedUserCertificates:      return "sharedUserCertificates";
        }
        return "unknown";
    }
