...
struct EngineConfig
{
    ...
    bool LoadFromRegistry(HKEY rootKey = HKEY_CURRENT_USER, const wchar_t* subKey = L"Software\\ExplorerLens\\Engine");

    /// Save configuration to registry
    /// @param rootKey Registry root
    /// @param subKey Registry subkey path
    /// @return true if saved successfully
    bool SaveToRegistry(HKEY rootKey = HKEY_CURRENT_USER,
