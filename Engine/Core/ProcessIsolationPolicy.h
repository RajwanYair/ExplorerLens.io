...
public:
    ...
    static const wchar_t* GetLevelName(IsolationLevel level) noexcept {
        switch (level) {
            case IsolationLevel::None:   return L"None";
            case IsolationLevel::Low:    return L"Low";
            case IsolationLevel::Medium: return L"Medium";
            case IsolationLevel::High:   return L"High";
            case IsolationLevel::Strict: return L"Strict";
    ...
    static const wchar_t* GetActionName(IsolationAction action) noexcept {
        switch (action) {
            case IsolationAction::Allow:   return L"Allow";
            case IsolationAction::Deny:    return L"Deny";
            case IsolationAction::Sandbox: return L"Sandbox";
            default:                       return L"Unknown";
        }
    }
...
private:
    ...
    void LoadBuiltinRules() noexcept {
        struct BuiltinRule { const wchar_t* ext; IsolationLevel level; IsolationAction action; };
