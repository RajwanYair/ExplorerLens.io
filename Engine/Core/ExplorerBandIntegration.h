...
{
    switch (value) {
        case BandPosition::Top:
            return "Top";
        case BandPosition::Bottom:
            return "Bottom";
        case BandPosition::Left:
            return "Left";
        case BandPosition::Right:
            return "Right";
        case BandPosition::Float:
            return "Float";
        default:
            return "Unknown";
    }
...
{
    switch (value) {
        case BandState::Hidden:
            return "Hidden";
        case BandState::Visible:
            return "Visible";
        case BandState::Docked:
            return "Docked";
        case BandState::Floating:
            return "Floating";
        case BandState::Minimized:
            return "Minimized";
        default:
            return "Unknown";
    }
...
class ExplorerBandIntegration
{
  public:
    ...
    bool SetVisibility(bool visible)
    {
        ...
        if (visible) {
            m_state = (m_config.position == BandPosition::Float) ? BandState::Floating : BandState::Docked;
        } else {
            m_state = BandState::Hidden;
        }
        return true;
