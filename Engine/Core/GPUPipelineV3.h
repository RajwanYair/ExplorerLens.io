...
class GPUPipelineV3
{
  public:
    ...
    {
        switch (f) {
            case GPUV3Feature::MeshShaders:
                return L"Mesh Shaders";
            case GPUV3Feature::EnhancedBarriers:
                return L"Enhanced Barriers";
            case GPUV3Feature::GPUDrivenDispatch:
                return L"GPU-Driven Dispatch";
            case GPUV3Feature::DirectStorage:
                return L"DirectStorage";
            case GPUV3Feature::PipelineLibrary:
                return L"Pipeline Library";
            case GPUV3Feature::WorkGraphs:
                return L"Work Graphs";
            default:
                return L"Unknown";
        }
    }
    ...
    {
        switch (q) {
            case PipelineV3Queue::DirectGraphics:
                return L"Direct/Graphics";
            case PipelineV3Queue::Compute:
                return L"Compute";
            case PipelineV3Queue::Copy:
                return L"Copy";
            case PipelineV3Queue::VideoDecode:
                return L"Video Decode";
            default:
                return L"Unknown";
        }
    }
    ...
    {
        switch (t) {
            case GPUV3PerfTier::Tier0_Legacy:
                return L"Legacy (D3D11)";
            case GPUV3PerfTier::Tier1_Basic:
                return L"Basic (D3D12)";
            case GPUV3PerfTier::Tier2_Enhanced:
                return L"Enhanced (Mesh Shaders)";
            case GPUV3PerfTier::Tier3_Advanced:
                return L"Advanced (Work Graphs)";
            default:
                return L"Unknown";
        }
    }
    ...
    {
        return static_cast<size_t>(GPUV3Feature::COUNT);
    }
    static constexpr size_t QueueCount()
    {
        return static_cast<size_t>(PipelineV3Queue::COUNT);
    }
    static constexpr size_t TierCount()
    {
        return static_cast<size_t>(GPUV3PerfTier::COUNT);
    }
