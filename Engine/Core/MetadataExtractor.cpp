...
std::vector<MetadataTag> MetadataExtractor::GetTagsByStandard(const ExtractionResult& result,
                                                              MetadataStandard standard) const
{
...
std::wstring MetadataExtractor::FormatGPSCoordinate(double degrees, double minutes, double seconds, wchar_t direction)
{
    ...
    ss << static_cast<int>(degrees) << L"° " << static_cast<int>(minutes) << L"' " << seconds << L"\" " << direction;
    return ss.str();
}
...
{
    switch (standard) {
        case MetadataStandard::EXIF:
            return L"EXIF";
        case MetadataStandard::IPTC:
            return L"IPTC";
        case MetadataStandard::XMP:
            return L"XMP";
        case MetadataStandard::ICC:
            return L"ICC";
        case MetadataStandard::GPS:
            return L"GPS";
        default:
            return L"Unknown";
    }
...
const wchar_t* MetadataExtractor::GetFieldName(MetadataField field)
{
    switch (field) {
        ...
        case MetadataField::Copyright:
            return L"Copyright";
        case MetadataField::DateCreated:
            return L"Date Created";
        case MetadataField::DateModified:
            return L"Date Modified";
        case MetadataField::CameraMake:
            return L"Camera Make";
        case MetadataField::CameraModel:
            return L"Camera Model";
        case MetadataField::FocalLength:
            return L"Focal Length";
        case MetadataField::Aperture:
            return L"Aperture";
        case MetadataField::ISO:
            return L"ISO";
        case MetadataField::ExposureTime:
            return L"Exposure Time";
        case MetadataField::GPSLatitude:
            return L"GPS Latitude";
        case MetadataField::GPSLongitude:
            return L"GPS Longitude";
        case MetadataField::Width:
            return L"Width";
        case MetadataField::Height:
            return L"Height";
        case MetadataField::ColorSpace:
