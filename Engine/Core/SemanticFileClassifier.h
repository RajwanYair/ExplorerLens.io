...
public:
    ...
    inline bool DetectBinary(const uint8_t* data, size_t size) const {
        ...
        for (size_t i = 0; i < checkLen; ++i) {
            ...
            else if (data[i] < 0x09 || (data[i] > 0x0D && data[i] < 0x20)) ++controlCount;
        }
    ...
    inline std::string CategoryToString(SemanticCategory cat) const {
        switch (cat) {
        case SemanticCategory::RasterImage:    return "Raster Image";
        case SemanticCategory::VectorGraphic:  return "Vector Graphic";
        case SemanticCategory::Document:       return "Document";
        case SemanticCategory::Archive:        return "Archive";
        case SemanticCategory::Video:          return "Video";
        case SemanticCategory::Audio:          return "Audio";
        case SemanticCategory::ThreeDModel:    return "3D Model";
        case SemanticCategory::SourceCode:     return "Source Code";
        case SemanticCategory::Executable:     return "Executable";
        case SemanticCategory::Font:           return "Font";
        case SemanticCategory::Database:       return "Database";
        case SemanticCategory::ScientificData: return "Scientific Data";
        case SemanticCategory::CADDrawing:     return "CAD Drawing";
        case SemanticCategory::Encrypted:      return "Encrypted";
