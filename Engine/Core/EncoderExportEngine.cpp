...
//------------------------------------------------------------------------------
bool EncoderExportEngine::WritePNG(const uint8_t* data, uint32_t w, uint32_t h,
...
bool EncoderExportEngine::WriteBMP(const uint8_t* data, uint32_t w, uint32_t h,
                                    const ExportConfig& /*config*/,
                                    std::vector<uint8_t>& output)
{
    if (!data || w == 0 || h == 0) return false;
...
const wchar_t* EncoderExportEngine::GetFormatName(ExportFormat format) {
    switch (format) {
        ...
        case ExportFormat::JPEG: return L"JPEG";
        case ExportFormat::WebP: return L"WebP";
        case ExportFormat::BMP:  return L"BMP";
        case ExportFormat::TIFF: return L"TIFF";
        case ExportFormat::ICO:  return L"ICO";
        case ExportFormat::GIF:  return L"GIF";
        case ExportFormat::JXL:  return L"JPEG XL";
        case ExportFormat::AVIF: return L"AVIF";
...
const wchar_t* EncoderExportEngine::GetFormatExtension(ExportFormat format) {
    switch (format) {
        ...
        case ExportFormat::ICO:  return L".ico";
        case ExportFormat::GIF:  return L".gif";
        case ExportFormat::JXL:  return L".jxl";
        case ExportFormat::AVIF: return L".avif";
...
const wchar_t* EncoderExportEngine::GetFormatMimeType(ExportFormat format) {
    switch (format) {
        case ExportFormat::PNG:  return L"image/png";
        case ExportFormat::JPEG: return L"image/jpeg";
        case ExportFormat::WebP: return L"image/webp";
        case ExportFormat::BMP:  return L"image/bmp";
        case ExportFormat::TIFF: return L"image/tiff";
        case ExportFormat::ICO:  return L"image/x-icon";
        case ExportFormat::GIF:  return L"image/gif";
        case ExportFormat::JXL:  return L"image/jxl";
        case ExportFormat::AVIF: return L"image/avif";
...
const wchar_t* EncoderExportEngine::GetColorSpaceName(ExportColorSpace cs) {
    switch (cs) {
        case ExportColorSpace::sRGB:      return L"sRGB";
        case ExportColorSpace::AdobeRGB:  return L"Adobe RGB";
        case ExportColorSpace::DisplayP3: return L"Display P3";
        case ExportColorSpace::LinearRGB: return L"Linear RGB";
        default: return L"Unknown";
    }
}
