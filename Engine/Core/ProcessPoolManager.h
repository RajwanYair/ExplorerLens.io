...
class ProcessPoolManager
{
  public:
    ...
    explicit ProcessPoolManager(const ProcessPoolConfig& cfg) noexcept : m_config(cfg) {}
    ...
    [[nodiscard]] int GetIdleCount() const noexcept
    {
        return m_idleCount;
    }
    [[nodiscard]] ProcessPriority GetPriority() const noexcept
    {
        return m_priority;
    }
    [[nodiscard]] const ProcessPoolConfig& GetConfig() const noexcept
    {
        return m_config;
    }

    void SetPriority(ProcessPriority prio) noexcept
    {
        m_priority = prio;
    }
