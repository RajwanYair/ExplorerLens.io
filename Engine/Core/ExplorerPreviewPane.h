...
{
    switch (m) {
        case PreviewPaneMode::Thumbnail:
            return "Thumbnail";
        case PreviewPaneMode::FullPreview:
            return "FullPreview";
        case PreviewPaneMode::Metadata:
            return "Metadata";
        case PreviewPaneMode::Slideshow:
            return "Slideshow";
        case PreviewPaneMode::Split:
            return "Split";
        default:
            return "Unknown";
    }
...
{
    switch (l) {
        case PreviewPaneLayout::Standard:
            return "Standard";
        case PreviewPaneLayout::Wide:
            return "Wide";
        case PreviewPaneLayout::Tall:
            return "Tall";
        case PreviewPaneLayout::Compact:
            return "Compact";
        case PreviewPaneLayout::Custom:
            return "Custom";
        default:
            return "Unknown";
    }
...
class ExplorerPreviewPane
{
  public:
    ...
    void SetShowMetadata(bool show) noexcept
    {
        m_config.showMetadata = show;
    }

    /// Toggle histogram overlay
    void SetShowHistogram(bool show) noexcept
    {
        m_config.showHistogram = show;
    }

    /// Get the current configuration
    const PreviewPaneConfig& GetConfig() const noexcept
    {
        return m_config;
    }
    ...
    /// Lifetime statistics
    uint64_t GetActivationCount() const noexcept
    {
        return m_activationCount;
    }
    uint64_t GetRefreshCount() const noexcept
    {
