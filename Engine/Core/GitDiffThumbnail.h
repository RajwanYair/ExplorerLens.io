...
enum class DiffViewMode { SideBySide, Unified, BeforeOnly, AfterOnly };
...
public:
    ...
    GitDiffInfo  Analyze(const std::string& path,
                         const std::string& beforeCommit,
                         const std::string& afterCommit) const {
        GitDiffInfo d;
