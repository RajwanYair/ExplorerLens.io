...
struct BuildInfo {
    static constexpr int MajorVersion = 28;
    static constexpr int MinorVersion = 4;
    static constexpr int PatchVersion = 0;
    static constexpr const char* VersionString = "28.4.0";
    static constexpr const char* Codename = "Polaris-U";
