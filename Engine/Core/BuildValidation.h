...
struct BuildInfo {
    ...
    static constexpr const char* VersionString = "31.9.0";
    static constexpr const char* Codename = "Achernar-Z";
    ...
    // Feature flags
    static constexpr int TotalMilestones = 490;
    static constexpr int CompletedMilestones = 490;

    // Subsystem count
    static constexpr int DecoderCount = 25;
    static constexpr int SupportedExtensions = 200;
    static constexpr int UnitTestCount = 4290;
