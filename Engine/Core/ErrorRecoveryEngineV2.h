...
inline const char* RecoveryStrategyV2Name(RecoveryStrategyV2 s) noexcept {
    switch (s) {
    case RecoveryStrategyV2::None:             return "None";
    case RecoveryStrategyV2::Retry:            return "Retry";
    case RecoveryStrategyV2::RetryWithBackoff: return "RetryWithBackoff";
    case RecoveryStrategyV2::Fallback:         return "Fallback";
    case RecoveryStrategyV2::Skip:             return "Skip";
    case RecoveryStrategyV2::Abort:            return "Abort";
...
public:
    ...
    size_t GetActionCount() const noexcept { return m_actions.size(); }
    ...
    const RecoveryStats& GetStats() const noexcept { return m_stats; }
