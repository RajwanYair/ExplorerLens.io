...
class OutOfProcThumbnailServer
{
  public:
    ...
    explicit OutOfProcThumbnailServer(const ServerConfig& cfg) noexcept : m_config(cfg) {}

    [[nodiscard]] ServerMode GetMode() const noexcept
    {
        return m_mode;
    }
    ...
    {
        return m_state == ServerState::Running;
    }
    [[nodiscard]] int GetClientCount() const noexcept
    {
    ...
    void SetMode(ServerMode mode) noexcept
    {
        m_mode = mode;
    }
    ...
    [[nodiscard]] uint64_t GetRequestCount() const noexcept
    {
    ...
    {
        switch (mode) {
            case ServerMode::InProc:
                return L"InProc";
            case ServerMode::OutOfProc:
                return L"OutOfProc";
