...
{
    switch (s) {
        case AssociationScope::User:
            return "User";
        case AssociationScope::Machine:
            return "Machine";
        case AssociationScope::AllUsers:
            return "AllUsers";
        case AssociationScope::Portable:
            return "Portable";
        case AssociationScope::GPOManaged:
            return "GPOManaged";
        default:
            return "Unknown";
    }
...
{
    switch (c) {
        case AssociationConflict::Overwrite:
            return "Overwrite";
        case AssociationConflict::Skip:
            return "Skip";
        case AssociationConflict::Backup:
            return "Backup";
        case AssociationConflict::Merge:
            return "Merge";
        case AssociationConflict::Prompt:
            return "Prompt";
        default:
            return "Unknown";
    }
...
class FileAssociationManager
{
  public:
    ...
    size_t GetRegisteredCount() const noexcept
    {
    ...
    uint64_t GetUnregisterCount() const noexcept
    {
        return m_unregisterCount;
    }

    /// Set default scope for new registrations
    void SetDefaultScope(AssociationScope scope) noexcept
    {
        m_defaultScope = scope;
    }

    /// Get default scope
    AssociationScope GetDefaultScope() const noexcept
    {
