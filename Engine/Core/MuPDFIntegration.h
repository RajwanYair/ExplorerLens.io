...
struct PDFRenderOptions
{
    ...
    bool fitToPage = true;         ///< Scale to fit target dimensions preserving aspect ratio
};
...
class MuPDFIntegration
{
  public:
    ...
    PDFRenderResult RenderPage(const wchar_t* filePath, const PDFRenderOptions& options = {})
    {
  ...
  private:
    ...
    PDFRenderResult RenderPageInternal(const wchar_t* filePath, const PDFRenderOptions& options);
...
inline MuPDFIntegration::Capability operator|(MuPDFIntegration::Capability a, MuPDFIntegration::Capability b)
{
    return static_cast<MuPDFIntegration::Capability>(static_cast<uint32_t>(a) | static_cast<uint32_t>(b));
}
inline MuPDFIntegration::Capability operator&(MuPDFIntegration::Capability a, MuPDFIntegration::Capability b)
{
    return static_cast<MuPDFIntegration::Capability>(static_cast<uint32_t>(a) & static_cast<uint32_t>(b));
