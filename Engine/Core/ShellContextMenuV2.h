...
public:
    ...
    static const wchar_t* GetActionName(ContextAction act) {
        ...
        case ContextAction::CopyHash:    return L"Copy Hash";
        case ContextAction::OpenManager: return L"Open Manager";
        case ContextAction::ExportThumb: return L"Export Thumbnail";
        case ContextAction::Disable:     return L"Disable";
    ...
    static constexpr size_t GetActionCount() { return 7; }
