...
enum class AnnotationRecordType {
    Star,
    Tag,
    Comment,
    Color,
...
struct Annotation
{
    ...
    {
        switch (type) {
            case AnnotationRecordType::Star:
                return "Star";
            case AnnotationRecordType::Tag:
                return "Tag";
            case AnnotationRecordType::Comment:
                return "Comment";
            case AnnotationRecordType::Color:
                return "Color";
            case AnnotationRecordType::Rating:
                return "Rating";
        }
        return "Unknown";
    }
  ...
  public:
    ...
    std::vector<Annotation> GetForFile(const std::wstring& filePath) const
    {
        ...
        for (const auto& a : m_annotations)
            if (!a.isDeleted && a.filePath == filePath)
                v.push_back(a);
        return v;
    }
