...
class CollaborationTelemetryHub
{
  public:
    ...
    {
        switch (e) {
            case CollabTelemetryEvent::SessionStarted:
                return "SessionStarted";
            case CollabTelemetryEvent::SessionEnded:
                return "SessionEnded";
            case CollabTelemetryEvent::AnnotationEdited:
                return "AnnotationEdited";
            case CollabTelemetryEvent::ConflictDetected:
                return "ConflictDetected";
            case CollabTelemetryEvent::ConflictResolved:
                return "ConflictResolved";
            case CollabTelemetryEvent::UserJoined:
                return "UserJoined";
            case CollabTelemetryEvent::UserLeft:
                return "UserLeft";
            case CollabTelemetryEvent::SyncCompleted:
