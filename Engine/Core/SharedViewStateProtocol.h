...
enum class ViewSortOrder { Name, Date, Size, Type, Stars, Custom };
enum class ViewGroupBy   { None, Type, Date, Stars };
enum class ViewZoomLevel { Tiny = 16, Small = 32, Medium = 96, Large = 256, ExtraLarge = 512 };
...
public:
    ...
    void SetViewStateCallback(ViewStateCallback cb) { m_callback = std::move(cb); }
    ...
    const SharedViewState& Current() const noexcept { return m_current; }
