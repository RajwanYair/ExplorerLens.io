...
public:
    ...
    static uint32_t GetHiveCount() { return static_cast<uint32_t>(RegHive::COUNT); }
    ...
    /// Read a string value
    std::wstring ReadString(RegHive hive, const std::wstring& key, const std::wstring& name, const std::wstring& defaultVal = L"") const;
    /// Delete a value
