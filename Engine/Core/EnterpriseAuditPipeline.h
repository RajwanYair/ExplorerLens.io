...
{
    switch (a) {
        case AuditAction::FileAccessed:
            return "FileAccessed";
        case AuditAction::ThumbnailGenerated:
            return "ThumbnailGenerated";
        case AuditAction::CacheHit:
            return "CacheHit";
        case AuditAction::ConfigChanged:
            return "ConfigChanged";
        case AuditAction::PluginLoaded:
            return "PluginLoaded";
        default:
            return "Unknown";
    }
...
{
    switch (d) {
        case AuditDestination::EventLog:
            return "EventLog";
        case AuditDestination::File:
            return "File";
        case AuditDestination::Syslog:
            return "Syslog";
        case AuditDestination::ETW:
            return "ETW";
        case AuditDestination::Database:
            return "Database";
        default:
            return "Unknown";
    }
...
class EnterpriseAuditPipeline
{
  public:
    ...
    void LogAction(AuditAction action, const std::wstring& filePath, const std::string& userId,
    ...
    AuditDestination GetDestination() const noexcept
    {
    ...
    {
        uint64_t cutoff = currentTimestamp - (static_cast<uint64_t>(RETENTION_DAYS) * 86400000ULL);
        uint32_t purged = 0;
