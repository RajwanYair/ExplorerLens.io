...
class ShellOverlayHandler
{
  public:
    ...
    {
        switch (t) {
            case OverlayIconType::Cached:
                return L"Cached";
            case OverlayIconType::NotCached:
                return L"Not Cached";
            case OverlayIconType::Processing:
                return L"Processing";
            case OverlayIconType::Error:
                return L"Error";
            case OverlayIconType::Warning:
                return L"Warning";
            case OverlayIconType::Protected:
                return L"Protected";
            case OverlayIconType::CloudSynced:
                return L"Cloud Synced";
            default:
                return L"Unknown";
        }
    }
