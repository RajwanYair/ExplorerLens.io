...
public:
    static const wchar_t* ToneMapName(ToneMappingOp op) {
        switch (op) {
            case ToneMappingOp::Reinhard:   return L"Reinhard";
            case ToneMappingOp::ACES:       return L"ACES";
            case ToneMappingOp::Filmic:     return L"Filmic";
            case ToneMappingOp::AgX:        return L"AgX";
            case ToneMappingOp::PBRNeutral: return L"PBR Neutral";
            case ToneMappingOp::Linear:     return L"Linear";
    ...
    static const wchar_t* GamutName(ColorGamut g) {
        switch (g) {
            case ColorGamut::sRGB:     return L"sRGB";
            case ColorGamut::AdobeRGB: return L"Adobe RGB";
            case ColorGamut::DCI_P3:   return L"DCI-P3";
            case ColorGamut::Rec2020:  return L"Rec.2020";
            case ColorGamut::ACEScg:   return L"ACEScg";
            default: return L"Unknown";
        }
    }
    ...
    static const wchar_t* HDRFormatName(HDRFormat f) {
        switch (f) {
            case HDRFormat::Radiance:     return L"Radiance HDR";
            case HDRFormat::OpenEXR:      return L"OpenEXR";
            case HDRFormat::HDR10:        return L"HDR10";
            case HDRFormat::DolbyVision:  return L"Dolby Vision";
            case HDRFormat::HLG:          return L"HLG";
            default: return L"Unknown";
        }
    }

    static constexpr size_t ToneMapCount() { return static_cast<size_t>(ToneMappingOp::COUNT); }
    static constexpr size_t GamutCount() { return static_cast<size_t>(ColorGamut::COUNT); }
    static constexpr size_t HDRFormatCount() { return static_cast<size_t>(HDRFormat::COUNT); }
