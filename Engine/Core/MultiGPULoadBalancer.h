...
class MultiGPULoadBalancer
{
  public:
    ...
    {
        switch (s) {
            case GPUBalanceStrategy::RoundRobin:
                return L"Round Robin";
            case GPUBalanceStrategy::LeastLoaded:
                return L"Least Loaded";
            case GPUBalanceStrategy::MemoryAware:
                return L"Memory Aware";
            case GPUBalanceStrategy::PowerEfficient:
                return L"Power Efficient";
            case GPUBalanceStrategy::PerformanceMax:
                return L"Performance Max";
            default:
                return L"Unknown";
        }
    }
    ...
    {
        return static_cast<size_t>(GPUBalanceStrategy::COUNT);
    }
    static constexpr size_t DeviceTypeCount()
    {
        return static_cast<size_t>(GPUDeviceType::COUNT);
    }
