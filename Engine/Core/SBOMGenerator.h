...
public:
    ...
    inline std::string GenerateSPDX() const {
        ...
        os << "{\n"
            ...
            << "  \"name\": \"ExplorerLens-29.7.0\",\n"
            << "  \"documentNamespace\": \"https://explorerlensteam.github.io/spdx/" << uuid << "\",\n"
            << "  \"creationInfo\": {\n"
            << "    \"created\": \"" << ts << "\",\n"
            << "    \"creators\": [\"Tool: ExplorerLens-SBOMGenerator-29.7.0\"]\n"
            << "  },\n"
            << "  \"packages\": [\n";
    ...
    inline bool SaveSBOM(const std::wstring& path,
        const std::string& format = "spdx") const {
        std::string content;
...
private:
    ...
    inline void PopulateDefaults() {
        m_deps = {
            {"zlib",       "1.3.1",  "Zlib",           "Jean-loup Gailly & Mark Adler",
             "https://zlib.net/", "", "pkg:generic/zlib@1.3.1"},

            {"LZ4",        "1.10.0", "BSD-2-Clause",   "Yann Collet",
             "https://github.com/lz4/lz4", "", "pkg:generic/lz4@1.10.0"},

            {"zstd",       "1.5.7",  "BSD-3-Clause",   "Meta Platforms / Yann Collet",
             "https://github.com/facebook/zstd", "", "pkg:generic/zstd@1.5.7"},

            {"LZMA SDK",   "26.00",  "public-domain",  "Igor Pavlov",
             "https://7-zip.org/sdk.html", "", "pkg:generic/lzma-sdk@26.00"},

            {"minizip-ng", "4.0.10", "Zlib",           "Nathan Moinvaziri",
             "https://github.com/zlib-ng/minizip-ng", "", "pkg:generic/minizip-ng@4.0.10"},

            {"UnRAR",      "7.2.2",  "LicenseRef-UnRAR-restrictive", "Alexander L. Roshal",
             "https://www.rarlab.com/rar_add.htm", "", "pkg:generic/unrar@7.2.2"},

            {"libwebp",    "1.5.0",  "BSD-3-Clause",   "Google LLC",
             "https://chromium.googlesource.com/webm/libwebp", "", "pkg:generic/libwebp@1.5.0"},

            {"libavif",    "1.3.0",  "BSD-2-Clause",   "Alliance for Open Media",
             "https://github.com/AOMediaCodec/libavif", "", "pkg:generic/libavif@1.3.0"},

            {"libjxl",     "0.11.1", "BSD-3-Clause",   "libjxl Contributors",
             "https://github.com/libjxl/libjxl", "", "pkg:generic/libjxl@0.11.1"},

            {"libheif",    "1.19.5", "LGPL-3.0-only",  "Dirk Farin",
             "https://github.com/nickt/libheif", "", "pkg:generic/libheif@1.19.5"},

            {"libde265",   "1.0.15", "LGPL-3.0-only",  "Dirk Farin",
             "https://github.com/nickt/libde265", "", "pkg:generic/libde265@1.0.15"},

            {"LibRaw",     "0.21.3", "LGPL-2.1-only OR CDDL-1.0", "LibRaw LLC",
             "https://www.libraw.org/", "", "pkg:generic/libraw@0.21.3"},

            {"dav1d",      "1.4.3",  "BSD-2-Clause",   "VideoLAN",
             "https://code.videolan.org/videolan/dav1d", "", "pkg:generic/dav1d@1.4.3"},
        };
    }
