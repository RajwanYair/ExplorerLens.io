...
public:
  ...
  enum class RefactorStatus { Planned, InProgress, Extracted, Verified, COUNT };
  ...
  static std::vector<ModuleInfo> GetModules() {
    return {
        {ExtractedModule::LENSTypes, L"LENSArchive.h", L"LENSTypes.h",
         RefactorStatus::Verified, 150},
        {ExtractedModule::ZipWrapper, L"LENSArchive.h", L"ZipWrapper.h",
         RefactorStatus::Verified, 400},
        {ExtractedModule::RarWrapper, L"LENSArchive.h", L"RarWrapper.h",
         RefactorStatus::Verified, 350},
        {ExtractedModule::ImageTypes, L"LENSArchive.h", L"ImageTypes.h",
         RefactorStatus::Verified, 100},
        {ExtractedModule::CLENSArchive, L"LENSArchive.h", L"LENSArchive.h",
         RefactorStatus::Verified, 1783},
    };
  }
