...
class PrefetchHintEngine
{
  public:
    ...
    explicit PrefetchHintEngine(const PrefetchHintConfig& config)
        : m_config(config)
        , m_caps(PrefetchCapabilities::Detect())
    {}
    ...
    const PrefetchHintConfig& GetConfig() const
    {
        return m_config;
    }

    /// Update configuration
    void SetConfig(const PrefetchHintConfig& config)
    {
        m_config = config;
    }

    /// Get statistics
    const PrefetchHintStats& GetStats() const
    {
        return m_stats;
    }
    ...
    const PrefetchCapabilities& GetCapabilities() const
    {
        return m_caps;
    }
    ...
    {
        switch (strategy) {
            case PrefetchHintStrategy::None:
                return "None";
            case PrefetchHintStrategy::Sequential:
                return "Sequential";
            case PrefetchHintStrategy::Stride:
                return "Stride";
            case PrefetchHintStrategy::Adaptive:
                return "Adaptive";
            default:
                return "Unknown";
        }
