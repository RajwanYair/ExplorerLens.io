...
class SecureDecodeContext
{
  public:
    ...
    [[nodiscard]] SecureDecodeResult Decode(const std::string& extension, const void* data, size_t size,
                                            uint32_t reqWidth = 256, uint32_t reqHeight = 256);
    ...
    [[nodiscard]] const SecureSandboxPolicy& Policy() const noexcept
    {
        return m_policy;
    }
...
inline constexpr FormatSandboxRule g_sandboxRules[] = {
    {".pdf", SandboxLevel::Isolated},   {".svg", SandboxLevel::Restricted}, {".ai", SandboxLevel::Isolated},
    {".eps", SandboxLevel::Isolated},   {".emf", SandboxLevel::Restricted}, {".wmf", SandboxLevel::Restricted},
    {".wma", SandboxLevel::Restricted}, {".mp4", SandboxLevel::Restricted}, {".avi", SandboxLevel::Restricted},
    {".mkv", SandboxLevel::Restricted}, {".7z", SandboxLevel::Isolated},    {".rar", SandboxLevel::Isolated},
