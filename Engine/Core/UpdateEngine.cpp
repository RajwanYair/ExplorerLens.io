...
const wchar_t* UpdateEngine::GetStatusName(UpdateStatus status) {
    switch (status) {
        case UpdateStatus::Unknown:     return L"Unknown";
        case UpdateStatus::UpToDate:    return L"Up to Date";
        case UpdateStatus::Available:   return L"Available";
        case UpdateStatus::Downloading: return L"Downloading";
        case UpdateStatus::Verifying:   return L"Verifying";
        case UpdateStatus::Ready:       return L"Ready";
        case UpdateStatus::Failed:      return L"Failed";
        default:                        return L"Unknown";
    }
}
