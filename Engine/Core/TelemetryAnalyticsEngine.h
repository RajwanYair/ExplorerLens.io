...
public:
    static const wchar_t* EventName(AnalyticsEventType e) noexcept {
        switch (e) {
        case AnalyticsEventType::ThumbnailGenerated: return L"ThumbnailGenerated";
        case AnalyticsEventType::CacheHit:           return L"CacheHit";
        case AnalyticsEventType::CacheMiss:          return L"CacheMiss";
        case AnalyticsEventType::DecoderError:       return L"DecoderError";
        case AnalyticsEventType::GPUFallback:        return L"GPUFallback";
        case AnalyticsEventType::PluginLoaded:       return L"PluginLoaded";
        case AnalyticsEventType::SessionStart:       return L"SessionStart";
        case AnalyticsEventType::SessionEnd:         return L"SessionEnd";
    ...
    static const wchar_t* ConsentName(TelemetryConsent c) noexcept {
        ...
        case TelemetryConsent::LocalOnly: return L"Local Only";
        case TelemetryConsent::Anonymous: return L"Anonymous";
        case TelemetryConsent::Enhanced:  return L"Enhanced";
        default:                          return L"Unknown";
        }
    }
