...
public:
 ...
 switch (s) {
 case CloudFileState::Available: return L"Available";
 case CloudFileState::OnlineOnly: return L"Online Only";
 case CloudFileState::Syncing: return L"Syncing";
 case CloudFileState::PinnedLocal: return L"Pinned Local";
 case CloudFileState::Conflict: return L"Conflict";
 default: return L"Unknown";
 }
 }
 ...
 switch (h) {
 case HydrationStrategy::AlwaysHydrate: return L"Always Hydrate";
 case HydrationStrategy::HydrateIfSmall: return L"Hydrate If Small";
 case HydrationStrategy::UseCloudThumb: return L"Use Cloud Thumbnail";
 case HydrationStrategy::Skip: return L"Skip";
 default: return L"Unknown";
 }
 }
 ...
 case HydrationStrategy::HydrateIfSmall: return info.fileSize <= cfg.maxHydrationSize;
 case HydrationStrategy::UseCloudThumb: return !info.hasCloudThumb;
 case HydrationStrategy::Skip: return false;
