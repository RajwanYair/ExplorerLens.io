...
class AnnotationExportPipelineV2
{
  public:
    ...
    {
        switch (fmt) {
            case AEPv2ExportFormat::JSON_LD:
                return "JSON-LD";
            case AEPv2ExportFormat::CSV:
                return "CSV";
            case AEPv2ExportFormat::XMP:
                return "XMP";
            case AEPv2ExportFormat::COCO:
                return "COCO";
        }
        return "Unknown";
    }
