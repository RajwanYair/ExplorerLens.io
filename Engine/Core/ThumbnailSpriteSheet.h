...
{
    switch (l) {
        case SpriteLayout::Grid:
            return "Grid";
        case SpriteLayout::Strip:
            return "Strip";
        case SpriteLayout::Atlas:
            return "Atlas";
        case SpriteLayout::TreePack:
            return "TreePack";
        case SpriteLayout::Custom:
            return "Custom";
        default:
            return "Unknown";
    }
...
{
    switch (f) {
        case SpriteOutputFormat::PNG:
            return "PNG";
        case SpriteOutputFormat::DDS:
            return "DDS";
        case SpriteOutputFormat::WebP:
            return "WebP";
        default:
            return "Unknown";
    }
...
class ThumbnailSpriteSheet
{
  public:
    ...
    void AddThumbnail(const std::wstring& /*path*/)
    {
        ++m_count;
    }
    ...
    uint32_t GetSpriteCount() const noexcept
    {
        return m_count;
    }
