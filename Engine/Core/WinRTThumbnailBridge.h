...
public:
    ...
    void SetSyncHandler(SyncThumbFn fn) { m_syncFn = std::move(fn); }
    ...
    static std::string ModeName(WinRTThumbnailMode mode) noexcept {
        switch (mode) {
        case WinRTThumbnailMode::SingleItem:    return "SingleItem";
        case WinRTThumbnailMode::ListView:      return "ListView";
        case WinRTThumbnailMode::PicturesView:  return "PicturesView";
        case WinRTThumbnailMode::VideosView:    return "VideosView";
        case WinRTThumbnailMode::MusicView:     return "MusicView";
        case WinRTThumbnailMode::DocumentsView: return "DocumentsView";
        }
        return "Unknown";
    }
