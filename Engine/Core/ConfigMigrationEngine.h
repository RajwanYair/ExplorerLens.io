#pragma once
// =============================================================================
// ConfigMigrationEngine.h — Sprint 247: Settings Migration Between Versions
...
/// ConfigMigrationEngine — migrates settings between DarkThumbs versions
...
public:
    ...
    uint32_t GetSettingCount() const { return static_cast<uint32_t>(m_settings.size()); }
    ...
    static constexpr uint32_t GetActionCount() { return static_cast<uint32_t>(MigrationAction::Count); }
