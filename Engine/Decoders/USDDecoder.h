...
class USDDecoder
{
  public:
    ...
    {
        switch (e) {
            case USDElementType::Mesh:
                return L"Mesh";
            case USDElementType::Camera:
                return L"Camera";
            case USDElementType::Light:
                return L"Light";
            case USDElementType::Material:
                return L"Material";
            case USDElementType::Xform:
                return L"Xform";
            case USDElementType::Scope:
                return L"Scope";
            case USDElementType::Shader:
                return L"Shader";
            default:
                return L"Unknown";
        }
    ...
    {
        switch (v) {
            case USDVariant::USDA:
                return L"USD ASCII";
            case USDVariant::USDC:
                return L"USD Crate";
            case USDVariant::USDZ:
                return L"USDZ Package";
            default:
                return L"Unknown";
        }
    }
    ...
    {
        if (ext == L".usda" || ext == L".usd")
            return USDVariant::USDA;
        if (ext == L".usdc")
            return USDVariant::USDC;
        if (ext == L".usdz")
            return USDVariant::USDZ;
        return USDVariant::USDA;
    }
    ...
    {
        return static_cast<size_t>(USDElementType::COUNT);
    }
    static constexpr size_t VariantCount()
    {
        return static_cast<size_t>(USDVariant::COUNT);
    }
};
