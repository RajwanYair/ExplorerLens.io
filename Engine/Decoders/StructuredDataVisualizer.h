...
enum class StructuredFormat : uint8_t {
    JSON,
    XML,
    YAML,
    TOML,
...
class StructuredDataVisualizer
{
  public:
    ...
    {
        return L"StructuredDataVisualizer";
    }
    ...
    StructuredFormat DetectFormat(const wchar_t* ext) const
    {
        ...
        for (auto& c : e)
            c = towlower(c);
        if (e == L".json" || e == L".geojson")
            return StructuredFormat::JSON;
        if (e == L".xml" || e == L".xsd" || e == L".xsl" || e == L".svg" || e == L".plist")
            return StructuredFormat::XML;
        if (e == L".yaml" || e == L".yml")
            return StructuredFormat::YAML;
        if (e == L".toml")
            return StructuredFormat::TOML;
        if (e == L".ini" || e == L".cfg" || e == L".conf")
            return StructuredFormat::INI;
        return StructuredFormat::Unknown;
    }
    ...
    StructuredDataStats GetStats() const
    {
        return m_stats;
    }
