...
class NotebookPreviewDecoder
{
  public:
    ...
    {
        switch (t) {
            case NotebookOutputType::Text:
                return L"Text";
            case NotebookOutputType::Image:
                return L"Image";
            case NotebookOutputType::HTML:
                return L"HTML";
            case NotebookOutputType::SVG:
                return L"SVG";
            case NotebookOutputType::LaTeX:
                return L"LaTeX";
            case NotebookOutputType::Error:
                return L"Error";
            default:
                return L"Unknown";
        }
    ...
    {
        switch (k) {
            case NotebookKernel::Python:
                return L"Python";
            case NotebookKernel::R:
                return L"R";
            case NotebookKernel::Julia:
                return L"Julia";
            case NotebookKernel::JavaScript:
                return L"JavaScript";
            case NotebookKernel::CSharp:
                return L"C#";
            case NotebookKernel::Unknown:
                return L"Unknown";
            default:
                return L"Unknown";
        }
    ...
    static constexpr size_t CellTypeCount()
    {
        return static_cast<size_t>(NotebookCellType::COUNT);
    }
    static constexpr size_t OutputTypeCount()
    {
        return static_cast<size_t>(NotebookOutputType::COUNT);
    }
    static constexpr size_t KernelCount()
    {
        return static_cast<size_t>(NotebookKernel::COUNT);
    }
};
