...
bool DICOMDecoder::ParseDataElement(const uint8_t* data, size_t size, size_t& offset)
{
    ...
    if (m_info.transferSyntax != DICOMTransferSyntax::ImplicitVRLittleEndian) {
        ...
        bool longVR = (std::strcmp(vr, "OB") == 0 || std::strcmp(vr, "OW") == 0 || std::strcmp(vr, "OF") == 0
                       || std::strcmp(vr, "SQ") == 0 || std::strcmp(vr, "UC") == 0 || std::strcmp(vr, "UN") == 0
...
//------------------------------------------------------------------------------
std::vector<uint8_t> DICOMDecoder::ExtractThumbnail(const uint8_t* data, size_t size, uint32_t thumbWidth,
