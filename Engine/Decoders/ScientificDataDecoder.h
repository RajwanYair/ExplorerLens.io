...
public:
    static const wchar_t* FormatName(ScientificDataFormat f) {
        switch (f) {
            case ScientificDataFormat::HDF5:    return L"HDF5";
            case ScientificDataFormat::NetCDF3: return L"NetCDF3";
            case ScientificDataFormat::NetCDF4: return L"NetCDF4";
            case ScientificDataFormat::GRIB:    return L"GRIB";
    ...
    static const wchar_t* DataTypeName(HDF5DataType t) {
        switch (t) {
            case HDF5DataType::Int8:     return L"Int8";
            case HDF5DataType::Int16:    return L"Int16";
            case HDF5DataType::Int32:    return L"Int32";
            case HDF5DataType::Int64:    return L"Int64";
            case HDF5DataType::Float32:  return L"Float32";
            case HDF5DataType::Float64:  return L"Float64";
            case HDF5DataType::String:   return L"String";
            case HDF5DataType::Compound: return L"Compound";
            default: return L"Unknown";
        }
    }
    ...
    static const wchar_t* VisModeName(SciVisMode m) {
        switch (m) {
            case SciVisMode::Heatmap:    return L"Heatmap";
            case SciVisMode::Contour:    return L"Contour";
            case SciVisMode::SliceView:  return L"Slice View";
            case SciVisMode::Histogram:  return L"Histogram";
            case SciVisMode::TimeSeries: return L"Time Series";
            default: return L"Unknown";
        }
    }
    ...
    static bool CheckHDF5Magic(const uint8_t* data, size_t size) {
        ...
        return data[0] == 0x89 && data[1] == 0x48 && data[2] == 0x44 &&
               data[3] == 0x46 && data[4] == 0x0D && data[5] == 0x0A &&
               data[6] == 0x1A && data[7] == 0x0A;
    }

    static constexpr size_t FormatCount() { return static_cast<size_t>(ScientificDataFormat::COUNT); }
    static constexpr size_t DataTypeCount() { return static_cast<size_t>(HDF5DataType::COUNT); }
