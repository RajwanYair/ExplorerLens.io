...
public:
 ...
 { L".txt", TextLanguage::PlainText },
 { L".md", TextLanguage::Markdown },
 { L".c", TextLanguage::C },
 { L".h", TextLanguage::C },
 { L".cpp", TextLanguage::CPP },
 { L".hpp", TextLanguage::CPP },
 { L".cxx", TextLanguage::CPP },
 { L".cc", TextLanguage::CPP },
 { L".py", TextLanguage::Python },
 { L".pyw", TextLanguage::Python },
 { L".js", TextLanguage::JavaScript },
 { L".mjs", TextLanguage::JavaScript },
 { L".ts", TextLanguage::TypeScript },
 { L".tsx", TextLanguage::TypeScript },
 { L".json", TextLanguage::JSON },
 { L".xml", TextLanguage::XML },
 { L".yaml", TextLanguage::YAML },
 { L".yml", TextLanguage::YAML },
 { L".html", TextLanguage::HTML },
 { L".htm", TextLanguage::HTML },
 { L".css", TextLanguage::CSS },
 { L".ps1", TextLanguage::PowerShell },
 { L".bat", TextLanguage::Batch },
 { L".cmd", TextLanguage::Batch },
 { L".ini", TextLanguage::INI },
 { L".cfg", TextLanguage::INI },
 { L".sql", TextLanguage::SQL },
 { L".rs", TextLanguage::Rust },
 { L".go", TextLanguage::Go },
 { L".java", TextLanguage::Java },
 ...
 switch (lang) {
 case TextLanguage::PlainText: return L"Plain Text";
 case TextLanguage::Markdown: return L"Markdown";
 case TextLanguage::C: return L"C";
 case TextLanguage::CPP: return L"C++";
 case TextLanguage::Python: return L"Python";
 case TextLanguage::JavaScript: return L"JavaScript";
 case TextLanguage::TypeScript: return L"TypeScript";
 case TextLanguage::JSON: return L"JSON";
 case TextLanguage::XML: return L"XML";
 case TextLanguage::YAML: return L"YAML";
 case TextLanguage::HTML: return L"HTML";
 case TextLanguage::CSS: return L"CSS";
 case TextLanguage::PowerShell: return L"PowerShell";
 case TextLanguage::Batch: return L"Batch";
 case TextLanguage::INI: return L"INI";
 case TextLanguage::SQL: return L"SQL";
 case TextLanguage::Rust: return L"Rust";
 case TextLanguage::Go: return L"Go";
 case TextLanguage::Java: return L"Java";
 case TextLanguage::CSharp: return L"C#";
 default: return L"Unknown";
 }
 }

 /// Count of supported languages
 static constexpr size_t LanguageCount() { return 20; }

 /// Count of supported extensions
 static size_t ExtensionCount() { return 31; }
 ...
 if (cfg.maxLines == 0 || cfg.maxLines > 200) return false;
 if (cfg.maxLineLength == 0 || cfg.maxLineLength > 500) return false;
 if (cfg.fontSize < 6 || cfg.fontSize > 32) return false;
 if (cfg.lineSpacing < cfg.fontSize) return false;
 return true;
 }
