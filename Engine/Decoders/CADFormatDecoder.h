...
public:
 ...
 switch (f) {
 case CADFormat::STEP_AP203: return L"STEP AP203";
 case CADFormat::STEP_AP214: return L"STEP AP214";
 case CADFormat::STEP_AP242: return L"STEP AP242";
 case CADFormat::IGES: return L"IGES";
 ...
 switch (e) {
 case CADEntity::Point: return L"Point";
 case CADEntity::Line: return L"Line";
 case CADEntity::Arc: return L"Arc";
 case CADEntity::Circle: return L"Circle";
 case CADEntity::Surface: return L"Surface";
 case CADEntity::Solid: return L"Solid";
 case CADEntity::Assembly: return L"Assembly";
 default: return L"Unknown";
 }
 }
 ...
 switch (m) {
 case CADRenderMode::Wireframe: return L"Wireframe";
 case CADRenderMode::HiddenLine: return L"Hidden Line";
 case CADRenderMode::Shaded: return L"Shaded";
 case CADRenderMode::ShadedEdges: return L"Shaded + Edges";
 case CADRenderMode::Xray: return L"X-Ray";
 default: return L"Unknown";
 }
 }
 ...
 static constexpr size_t FormatCount() { return static_cast<size_t>(CADFormat::COUNT); }
 static constexpr size_t EntityCount() { return static_cast<size_t>(CADEntity::COUNT); }
