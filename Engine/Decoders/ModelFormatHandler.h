  ...
  public:
    ...
    static PrintModel3DFormat DetectFormat(const std::wstring& ext)
    {
        static const std::unordered_map<std::wstring, PrintModel3DFormat> extMap = {
            {L".3mf", PrintModel3DFormat::ThreeMF}, {L".usd", PrintModel3DFormat::USD},
            {L".usda", PrintModel3DFormat::USDA},   {L".usdc", PrintModel3DFormat::USDC},
            {L".usdz", PrintModel3DFormat::USDZ},   {L".stp", PrintModel3DFormat::STEP},
            {L".step", PrintModel3DFormat::STEP},   {L".igs", PrintModel3DFormat::IGES},
