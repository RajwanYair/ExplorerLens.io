...
KTXTextureInfo KTXTextureDecoder::ReadInfo(const std::string& filePath) const
{
    ...
    if (memcmp(magic, KTX1_MAGIC, 12) == 0) {
        ...
        info.supercompression =
            static_cast<KTXSupercompression>((hdr.supercompressionScheme < 4) ? hdr.supercompressionScheme : 0);
...
//==========================================================================
KTXDecodeResult KTXTextureDecoder::Decode(const std::string& filePath, uint32_t targetWidth) const
{
...
//==========================================================================
void KTXTextureDecoder::DecompressBC1Block(const uint8_t* block, uint8_t* output, uint32_t outputStride) const
{
...
TextureCompression KTXTextureDecoder::MapGLFormat(uint32_t glFormat) const
{
    ...
    switch (glFormat) {
        case 0x83F0:
            return TextureCompression::BC1_RGB;  // GL_COMPRESSED_RGB_S3TC_DXT1_EXT
        case 0x83F1:
            return TextureCompression::BC1_RGB;  // GL_COMPRESSED_RGBA_S3TC_DXT1_EXT
        case 0x83F2:
            return TextureCompression::BC3_RGBA;  // GL_COMPRESSED_RGBA_S3TC_DXT3_EXT
        case 0x83F3:
            return TextureCompression::BC3_RGBA;  // GL_COMPRESSED_RGBA_S3TC_DXT5_EXT
        case 0x8DBB:
            return TextureCompression::BC4_R;  // GL_COMPRESSED_RED_RGTC1
        case 0x8DBC:
            return TextureCompression::BC4_R;  // GL_COMPRESSED_SIGNED_RED_RGTC1
        case 0x8DBD:
            return TextureCompression::BC5_RG;  // GL_COMPRESSED_RG_RGTC2
        case 0x8E8C:
            return TextureCompression::BC7_RGBA;  // GL_COMPRESSED_RGBA_BPTC_UNORM
        case 0x8E8E:
            return TextureCompression::BC6H_RGB_Float;  // GL_COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT
        case 0x9274:
            return TextureCompression::ETC2_RGB;  // GL_COMPRESSED_RGB8_ETC2
        case 0x9278:
            return TextureCompression::ETC2_RGBA;  // GL_COMPRESSED_RGBA8_ETC2_EAC
        default:
...
TextureCompression KTXTextureDecoder::MapVkFormat(uint32_t vkFormat) const
{
    ...
    switch (vkFormat) {
        case 131:
        case 132:
            return TextureCompression::BC1_RGB;  // VK_FORMAT_BC1_RGB[A]_UNORM
        case 135:
        case 136:
            return TextureCompression::BC3_RGBA;  // VK_FORMAT_BC3_UNORM
        case 139:
            return TextureCompression::BC4_R;  // VK_FORMAT_BC4_UNORM
        case 141:
            return TextureCompression::BC5_RG;  // VK_FORMAT_BC5_UNORM
        case 143:
            return TextureCompression::BC6H_RGB_Float;  // VK_FORMAT_BC6H_UFLOAT
        case 145:
        case 146:
            return TextureCompression::BC7_RGBA;  // VK_FORMAT_BC7_UNORM/SRGB
        case 147:
        case 148:
            return TextureCompression::ETC2_RGB;  // VK_FORMAT_ETC2_R8G8B8_UNORM
        case 151:
        case 152:
            return TextureCompression::ETC2_RGBA;  // VK_FORMAT_ETC2_R8G8B8A8_UNORM
        case 157:
            return TextureCompression::ASTC_4x4;  // VK_FORMAT_ASTC_4x4_UNORM
        case 163:
            return TextureCompression::ASTC_6x6;  // VK_FORMAT_ASTC_6x6_UNORM
        case 169:
            return TextureCompression::ASTC_8x8;  // VK_FORMAT_ASTC_8x8_UNORM
        default:
            return TextureCompression::Uncompressed;
    }
}

KTXDecodeResult KTXTextureDecoder::DecodeUncompressed(const std::vector<uint8_t>& data, const KTXTextureInfo& info,
...
KTXDecodeResult KTXTextureDecoder::DecodeBlockCompressed(const std::vector<uint8_t>& data, const KTXTextureInfo& info,
                                                         uint32_t mipLevel) const
{
    KTXDecodeResult result;
    result.info = info;
