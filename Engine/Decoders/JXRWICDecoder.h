...
public:
    ...
    JXRImageInfo ReadInfo(const std::string& filePath) const {
        ...
        // Parse JPEG XR TIFF-like container to extract real image dimensions.
        // Layout: "II" (LE byte order) + 0xBC (JXR magic) + version + IFD0 offset.
        // IFD uses JPEG XR tags: 0xBC80=Width, 0xBC81=Height, 0xBC82/83=DPI.
        FILE* fp = nullptr;
#ifdef _MSC_VER
        ...
        if (info.hasAlpha)
            ...
            info.pixelFormat = JXRPixelFormat::BGR24;
