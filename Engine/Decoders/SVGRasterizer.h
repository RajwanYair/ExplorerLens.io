...
class SVGRasterizer
{
  public:
    ...
    [[nodiscard]] std::optional<SVGRasterizeResult> Rasterize(const void* svgData, size_t svgSize,
  ...
  private:
    std::optional<SVGRasterizeResult> RasterizeWithD2D(const void* data, size_t size,
                                                       const SVGRasterizeOptions& opts) const;

    std::optional<SVGRasterizeResult> RasterizeFallback(const void* data, size_t size,
                                                        const SVGRasterizeOptions& opts) const;
