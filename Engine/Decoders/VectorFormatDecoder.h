...
class VectorFormatDecoder
{
  public:
    ...
    {
        switch (f) {
            case VectorFormat::CDR:
                return L"CorelDRAW";
            case VectorFormat::CMX:
                return L"Corel CMX";
            case VectorFormat::VSD:
                return L"Visio Binary";
            case VectorFormat::VSDX:
                return L"Visio OOXML";
            case VectorFormat::AI:
                return L"Illustrator";
            case VectorFormat::WMF:
    ...
    {
        switch (e) {
            case VectorElement::Path:
                return L"Path";
            case VectorElement::Rectangle:
                return L"Rectangle";
            case VectorElement::Ellipse:
                return L"Ellipse";
            case VectorElement::Text:
                return L"Text";
            case VectorElement::Image:
                return L"Image";
            case VectorElement::Group:
                return L"Group";
            case VectorElement::Layer:
                return L"Layer";
            default:
                return L"Unknown";
        }
    ...
    static VectorFormat DetectFormat(const std::wstring& ext)
    {
        ...
        if (ext == L".cmx")
            return VectorFormat::CMX;
        if (ext == L".vsd")
            return VectorFormat::VSD;
        if (ext == L".vsdx")
            return VectorFormat::VSDX;
        if (ext == L".ai")
            return VectorFormat::AI;
        if (ext == L".wmf")
            return VectorFormat::WMF;
        if (ext == L".emf")
            return VectorFormat::EMF;
        return VectorFormat::CDR;
    }

    static constexpr size_t FormatCount()
    {
        return static_cast<size_t>(VectorFormat::COUNT);
    }
    static constexpr size_t ElementCount()
    {
        return static_cast<size_t>(VectorElement::COUNT);
    }
};
