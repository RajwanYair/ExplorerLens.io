...
class NIfTIDecoder
{
  public:
    static const wchar_t* DataTypeName(NIfTIDataType t)
    {
        switch (t) {
            ...
            case NIfTIDataType::Float64:
                return L"Float64";
            case NIfTIDataType::Complex64:
                return L"Complex64";
            case NIfTIDataType::RGB24:
                return L"RGB24";
            default:
                return L"Unknown";
        }
    ...
    {
        switch (s) {
            case NIfTISlice::Axial:
                return L"Axial";
            case NIfTISlice::Coronal:
                return L"Coronal";
            case NIfTISlice::Sagittal:
                return L"Sagittal";
            default:
                return L"Unknown";
        }
    ...
    {
        switch (v) {
            case NIfTIVariant::NIfTI1:
                return L"NIfTI-1";
            case NIfTIVariant::NIfTI2:
                return L"NIfTI-2";
            case NIfTIVariant::Analyze75:
                return L"Analyze 7.5";
            case NIfTIVariant::GZipped:
                return L"NIfTI GZipped";
            default:
                return L"Unknown";
        }
    }
    ...
    {
        return static_cast<size_t>(NIfTIDataType::COUNT);
    }
    static constexpr size_t SliceCount()
    {
        return static_cast<size_t>(NIfTISlice::COUNT);
    }
    static constexpr size_t VariantCount()
    {
        return static_cast<size_t>(NIfTIVariant::COUNT);
    }
};
