...
class DatabasePreviewDecoder
{
  public:
    static const wchar_t* EngineName(DatabaseEngine e)
    {
        switch (e) {
            ...
            case DatabaseEngine::Access:
                return L"Access";
            case DatabaseEngine::DBase:
                return L"dBASE";
            case DatabaseEngine::Paradox:
                return L"Paradox";
            default:
                return L"Unknown";
        }
    ...
    {
        switch (s) {
            case DatabasePreviewStyle::SchemaView:
                return L"Schema View";
            case DatabasePreviewStyle::DataGrid:
                return L"Data Grid";
            case DatabasePreviewStyle::ERDiagram:
                return L"ER Diagram";
            case DatabasePreviewStyle::Statistics:
                return L"Statistics";
            default:
                return L"Unknown";
        }
    ...
    static constexpr size_t EngineCount()
    {
        return static_cast<size_t>(DatabaseEngine::COUNT);
    }
    static constexpr size_t ColumnTypeCount()
    {
        return static_cast<size_t>(SQLColumnType::COUNT);
    }
    static constexpr size_t PreviewStyleCount()
    {
        return static_cast<size_t>(DatabasePreviewStyle::COUNT);
    }
};
