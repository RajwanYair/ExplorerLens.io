...
class ShortcutInspector
{
  public:
    ...
    bool DetectMagic(const uint8_t* data, size_t size) const
    {
        ...
        static const uint8_t lnkCLSID[] = {0x01, 0x14, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00,
                                           0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46};
        return memcmp(data, lnkMagic, 4) == 0 && memcmp(data + 4, lnkCLSID, 16) == 0;
    }
    ...
    ShortcutInfo Parse(const uint8_t* data, size_t size) const
    {
        ...
        info.pointsToFile = (info.fileAttributes & 0x20) == 0 && (info.fileAttributes & 0x10) == 0;
