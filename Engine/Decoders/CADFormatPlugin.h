...
{
    switch (f) {
        case PluginCADFormat::DWG:
            return "DWG";
        case PluginCADFormat::DXF:
            return "DXF";
        case PluginCADFormat::DWF:
            return "DWF";
        case PluginCADFormat::DWFx:
            return "DWFx";
        case PluginCADFormat::DGN:
            return "DGN";
        case PluginCADFormat::STEP:
            return "STEP";
        case PluginCADFormat::IGES:
            return "IGES";
        default:
            return "Unknown";
    }
...
{
    if (ext == ".dwg")
        return PluginCADFormat::DWG;
    if (ext == ".dxf")
        return PluginCADFormat::DXF;
    if (ext == ".dwf")
        return PluginCADFormat::DWF;
    if (ext == ".dwfx")
        return PluginCADFormat::DWFx;
    if (ext == ".dgn")
        return PluginCADFormat::DGN;
    if (ext == ".stp" || ext == ".step")
        return PluginCADFormat::STEP;
    if (ext == ".igs" || ext == ".iges")
        return PluginCADFormat::IGES;
