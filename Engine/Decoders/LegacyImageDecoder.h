...
class LegacyImageDecoder
{
  public:
    ...
    {
        switch (f) {
            case LegacyImageFormat::FLIF:
                return L"FLIF";
            case LegacyImageFormat::BPG:
                return L"BPG";
            case LegacyImageFormat::JPEG2000:
                return L"JPEG 2000";
            case LegacyImageFormat::PCX:
                return L"PCX";
            case LegacyImageFormat::TGA:
                return L"TGA";
            case LegacyImageFormat::SGI:
                return L"SGI";
            default:
                return L"Unknown";
        }
    ...
    {
        switch (cs) {
            case LegacyColorSpace::Grayscale:
                return L"Grayscale";
            case LegacyColorSpace::RGB:
                return L"RGB";
            case LegacyColorSpace::RGBA:
                return L"RGBA";
            case LegacyColorSpace::YCbCr:
                return L"YCbCr";
            case LegacyColorSpace::CMYK:
                return L"CMYK";
            case LegacyColorSpace::Palette:
                return L"Palette";
            default:
                return L"Unknown";
        }
    ...
    {
        return static_cast<size_t>(LegacyImageFormat::COUNT);
    }
    static constexpr size_t ColorSpaceCount()
    {
        return static_cast<size_t>(LegacyColorSpace::COUNT);
    }
};
