...
class LiveStreamDecoder
{
  public:
    ...
    {
        switch (proto) {
            case LiveStreamProtocol::HLS:
                return "HLS";
            case LiveStreamProtocol::RTSP:
                return "RTSP";
            case LiveStreamProtocol::RTMP:
                return "RTMP";
            case LiveStreamProtocol::SmoothStream:
                return "SmoothStream";
        }
        return "Unknown";
    }
