//==============================================================================
// DarkThumbs Engine — Sprint 307: Audio Visualization V2
...
public:
    static const wchar_t* ModeName(AudioVisMode m) {
        switch (m) {
            case AudioVisMode::AlbumArt:     return L"Album Art";
            case AudioVisMode::Waveform:     return L"Waveform";
            case AudioVisMode::Spectrum:     return L"Spectrum";
            case AudioVisMode::CircularWave: return L"Circular Wave";
            case AudioVisMode::Oscilloscope: return L"Oscilloscope";
    ...
    static const wchar_t* ColorSchemeName(AudioVisColorScheme c) {
        switch (c) {
            case AudioVisColorScheme::Classic:    return L"Classic";
            case AudioVisColorScheme::Neon:       return L"Neon";
            case AudioVisColorScheme::Pastel:     return L"Pastel";
            case AudioVisColorScheme::Monochrome: return L"Monochrome";
            default: return L"Unknown";
        }
    }
    ...
    static const wchar_t* LoudnessUnitName(LoudnessUnit u) {
        switch (u) {
            case LoudnessUnit::LUFS: return L"LUFS";
            case LoudnessUnit::RMS:  return L"RMS";
            case LoudnessUnit::Peak: return L"True Peak";
            default: return L"Unknown";
        }
    }

    static constexpr size_t ModeCount()        { return static_cast<size_t>(AudioVisMode::COUNT); }
    static constexpr size_t ColorSchemeCount() { return static_cast<size_t>(AudioVisColorScheme::COUNT); }
    static constexpr size_t LoudnessUnitCount(){ return static_cast<size_t>(LoudnessUnit::COUNT); }
