...
private:
    ...
    static std::vector<uint8_t> DecompressPackBits(
        const uint8_t* src, size_t srcLen, size_t expectedBytes);

    static void CMYKtoRGB(uint8_t c, uint8_t m, uint8_t y, uint8_t k,
