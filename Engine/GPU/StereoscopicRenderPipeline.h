...
enum class StereoLayout { SideBySide, TopBottom, Anaglyph };
...
public:
    ...
    bool IsHardwareAvailable() const { return true; }
    static std::string LayoutName(StereoLayout layout) {
        switch (layout) {
            case StereoLayout::SideBySide: return "SideBySide";
            case StereoLayout::TopBottom:  return "TopBottom";
            case StereoLayout::Anaglyph:   return "Anaglyph";
        }
        return "Unknown";
    }
};
