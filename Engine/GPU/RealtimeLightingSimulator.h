...
enum class LightingModel { Lambertian, PhysicallyBased, UnrealEngine5 };
enum class EnvironmentMap { Studio, Outdoor, Indoor, Custom };
...
public:
    ...
    static std::string ModelName(LightingModel m) noexcept {
        switch (m) {
        case LightingModel::Lambertian:        return "Lambertian";
        case LightingModel::PhysicallyBased:   return "PBR";
        case LightingModel::UnrealEngine5:     return "UE5";
        }
        return "Unknown";
    }
    ...
    static std::string EnvMapName(EnvironmentMap e) noexcept {
        switch (e) {
        case EnvironmentMap::Studio:  return "Studio";
        case EnvironmentMap::Outdoor: return "Outdoor";
        case EnvironmentMap::Indoor:  return "Indoor";
        case EnvironmentMap::Custom:  return "Custom";
        }
        return "Unknown";
    }
};
