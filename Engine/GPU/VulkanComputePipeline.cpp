...
bool VulkanComputePipeline::Dispatch(const ComputeDispatch &params,
 ...
 const size_t requiredDstSize =
 static_cast<size_t>(params.dstWidth) * params.dstHeight * 4;
 ...
 CPUResize(srcData, params.srcWidth, params.srcHeight, dstData,
...
//------------------------------------------------------------------------------
void VulkanComputePipeline::CPUResize(const uint8_t *src, uint32_t srcW,
 uint32_t srcH, uint8_t *dst,
