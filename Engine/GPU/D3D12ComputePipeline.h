#pragma once
//==============================================================================
// D3D12ComputePipeline — Sprint 188
...
public:
    ...
    ComputeResult Resize(const uint8_t* inputData,
                          uint32_t inputWidth,
    ...
    ComputeResult ToneMap(const uint8_t* inputData,
                           uint32_t width,
                           uint32_t height,
                           ToneMapOperator op);

    /// Convert color space
    ComputeResult ConvertColorSpace(const uint8_t* inputData,
                                     uint32_t width,
                                     uint32_t height,
...
private:
    ...
    ComputeResult ResizeCPU(const uint8_t* inputData,
                             uint32_t inputWidth,
                             uint32_t inputHeight,
                             uint32_t outputWidth,
                             uint32_t outputHeight);
    ...
    void CalculateDispatch(uint32_t width, uint32_t height,
