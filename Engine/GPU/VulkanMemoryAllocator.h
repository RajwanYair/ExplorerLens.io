...
{
    switch (t) {
        case VkMemoryTier::DeviceLocal:
            return "DeviceLocal";
        case VkMemoryTier::HostVisible:
            return "HostVisible";
        case VkMemoryTier::HostCached:
            return "HostCached";
        case VkMemoryTier::LazyAlloc:
            return "LazyAlloc";
        case VkMemoryTier::Shared:
            return "Shared";
        default:
            return "Unknown";
    }
...
{
    switch (s) {
        case VkAllocStrategy::BestFit:
            return "BestFit";
        case VkAllocStrategy::FirstFit:
            return "FirstFit";
        case VkAllocStrategy::PoolBased:
            return "PoolBased";
        case VkAllocStrategy::Dedicated:
            return "Dedicated";
        case VkAllocStrategy::Suballocate:
            return "Suballocate";
        default:
            return "Unknown";
    }
...
class VulkanMemoryAllocator
{
  public:
    ...
    bool Allocate(VkMemoryTier tier, VkAllocStrategy strategy, uint64_t sizeBytes, VkMemoryBlock& outBlock)
    {
        ...
        outBlock.isMapped = (tier == VkMemoryTier::HostVisible || tier == VkMemoryTier::HostCached);
    ...
    uint64_t GetUsageBytes() const noexcept
    {
    ...
    uint32_t GetFreeSlots() const noexcept
    {
        return MAX_BLOCKS - m_blockCount;
    }
