...
enum class PathTracerHWBackend { DXR, VulkanRT, SoftwareFallback };
enum class PathTracerQuality   { Preview_1spp, Quality_4spp, Final_16spp };
...
public:
    ...
    PathTracerHWBackend GetBackend() const noexcept { return m_backend; }

    static std::string BackendName(PathTracerHWBackend b) noexcept {
        switch (b) {
        case PathTracerHWBackend::DXR:              return "DXR";
        case PathTracerHWBackend::VulkanRT:         return "VulkanRT";
        case PathTracerHWBackend::SoftwareFallback: return "SoftwareFallback";
        }
        return "Unknown";
    }
    ...
    static int SamplesForQuality(PathTracerQuality q) noexcept {
        switch (q) {
        case PathTracerQuality::Preview_1spp: return 1;
        case PathTracerQuality::Quality_4spp: return 4;
        case PathTracerQuality::Final_16spp:  return 16;
        }
        return 1;
    }
