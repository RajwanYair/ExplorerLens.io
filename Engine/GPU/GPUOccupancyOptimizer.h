...
{
  public:
    void SetArchitecture(GPUArchitecture arch)
    {
        m_arch = arch;
    }
    ...
    void SetConfig(const OccupancyConfig& cfg)
    {
        m_config = cfg;
    }
    const OccupancyConfig& GetConfig() const
    {
        return m_config;
    }
    ...
    static size_t ArchCount()
    {
        return static_cast<size_t>(GPUArchitecture::COUNT);
    }
