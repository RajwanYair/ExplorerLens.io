...
public:
    ...
    HRESULT GetGPUInfo(
        wchar_t* outName, 
        uint32_t nameSize, 
        uint32_t* outMemoryMB) const override;
    
    const wchar_t* GetRendererType() const override { return L"GDI+ (CPU)"; }
