...
class DecodePriorityQueue
{
  public:
    ...
    QueuedDecodeRequest Dequeue()
    {
        ...
        std::sort(m_requests.begin(), m_requests.end(), [](const QueuedDecodeRequest& a, const QueuedDecodeRequest& b) {
    ...
    {
        return static_cast<size_t>(QueuePriority::COUNT);
    }
