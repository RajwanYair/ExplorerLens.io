...
{
    static const wchar_t* names[] = {L"IOTimeout",      L"GPUDeviceLost", L"MemoryPressure", L"CodecBusy",
                                     L"NetworkTimeout", L"FileLocked",    L"Unknown"};
...
class DecodeRetryPolicy
{
  public:
    ...
    {
        switch (kind) {
            case DecodeFailureKind::IOTimeout:
                return m_config.retryOnIOTimeout;
            case DecodeFailureKind::GPUDeviceLost:
                return m_config.retryOnGPULost;
            case DecodeFailureKind::MemoryPressure:
                return m_config.retryOnMemoryPressure;
            case DecodeFailureKind::CodecBusy:
                return m_config.retryOnCodecBusy;
            case DecodeFailureKind::NetworkTimeout:
                return m_config.retryOnNetworkTimeout;
            case DecodeFailureKind::FileLocked:
                return m_config.retryOnFileLocked;
            default:
                return false;
        }
    }
    ...
    // Get config
    const DecodeRetryConfig& GetConfig() const
    {
        return m_config;
    }

    // Get stats
    DecodeRetryStats GetStats() const
    {
        return m_stats;
    }
