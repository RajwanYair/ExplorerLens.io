//==============================================================================
// DarkThumbs Engine — Sprint 305: Smart Format Detector V2
...
public:
    static const wchar_t* MethodName(DetectionMethod m) {
        switch (m) {
            case DetectionMethod::Extension:    return L"Extension";
            case DetectionMethod::MagicBytes:   return L"Magic Bytes";
            case DetectionMethod::DeepScan:     return L"Deep Scan";
            case DetectionMethod::MLClassifier: return L"ML Classifier";
    ...
    static const wchar_t* ConfidenceName(DetectionConfidence c) {
        switch (c) {
            ...
            case DetectionConfidence::Low:     return L"Low (<50%)";
            case DetectionConfidence::Medium:  return L"Medium (50-80%)";
            case DetectionConfidence::High:    return L"High (80-95%)";
            case DetectionConfidence::Certain: return L"Certain (>95%)";
            default: return L"Unknown";
        }
    }
    ...
    static const wchar_t* HintName(DetectionHint h) {
        switch (h) {
            case DetectionHint::None:           return L"None";
            case DetectionHint::PreferFast:     return L"Prefer Fast";
            case DetectionHint::PreferAccurate: return L"Prefer Accurate";
            case DetectionHint::TrustExtension: return L"Trust Extension";
            default: return L"Unknown";
        }
    }

    static constexpr size_t MethodCount()     { return static_cast<size_t>(DetectionMethod::COUNT); }
    static constexpr size_t ConfidenceCount() { return static_cast<size_t>(DetectionConfidence::COUNT); }
    static constexpr size_t HintCount()       { return static_cast<size_t>(DetectionHint::COUNT); }
