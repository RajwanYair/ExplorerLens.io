...
public:
    ...
    static ScalerAlgorithm RecommendAlgorithm(
        uint32_t srcW, uint32_t srcH,
        uint32_t dstW, uint32_t dstH);

private:
    ScaleResult ScaleLanczos3(
        const uint8_t* src, uint32_t sw, uint32_t sh,
        uint32_t dw, uint32_t dh) const;

    ScaleResult ScaleBicubic(
        const uint8_t* src, uint32_t sw, uint32_t sh,
        uint32_t dw, uint32_t dh) const;

    ScaleResult ScaleBilinear(
        const uint8_t* src, uint32_t sw, uint32_t sh,
        uint32_t dw, uint32_t dh) const;

    ScaleResult ScaleAreaAverage(
        const uint8_t* src, uint32_t sw, uint32_t sh,
        uint32_t dw, uint32_t dh) const;
