//==============================================================================
// DarkThumbs Engine - Format Detector Header
...
public:
    ...
    FormatType DetectFormat(const wchar_t* filePath) override;
    FormatType DetectFromExtension(const wchar_t* extension) override;
    FormatType DetectFromSignature(const wchar_t* filePath) override;
