...
class ThumbnailPipeline
{
  public:
    ...
    std::vector<ThumbnailResult> GenerateThumbnailsBatch(const std::vector<ThumbnailRequest>& requests);
    ...
    void GetStatistics(uint64_t& totalRequests, uint64_t& cacheHits, uint64_t& cacheMisses, double& averageTimeMs) const;
