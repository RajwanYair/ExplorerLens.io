...
{
    switch (r) {
        case ScalingReason::CPULoad:
            return "CPULoad";
        case ScalingReason::MemoryPressure:
            return "MemoryPressure";
        case ScalingReason::GPULoad:
            return "GPULoad";
        case ScalingReason::BatteryLow:
            return "BatteryLow";
        case ScalingReason::UserRequest:
            return "UserRequest";
        default:
            return "Unknown";
    }
...
class AdaptiveQualityScaler
{
  public:
    ...
    QualityDecision Evaluate(float cpuPercent, float memPercent, float gpuPercent, bool onBattery)
    {
    ...
    QualityTier GetCurrentTier() const
    {
        return m_currentDecision.tier;
    }

    QualityDecision GetOptimalQuality() const
    {
