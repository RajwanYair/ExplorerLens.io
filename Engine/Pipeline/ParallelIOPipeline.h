...
public:
  static const wchar_t *BackendName(IOBackend b) {
    switch (b) {
    case IOBackend::Win32Overlapped:
      return L"Win32 Overlapped";
    case IOBackend::IOCP:
      return L"I/O Completion Port";
    case IOBackend::WinRTAsync:
      return L"WinRT Async";
    case IOBackend::DirectStorage:
  ...
  static const wchar_t *VolumeTypeName(VolumeType v) {
    switch (v) {
    case VolumeType::NVMe:
      return L"NVMe SSD";
    case VolumeType::SATA_SSD:
      return L"SATA SSD";
    case VolumeType::HDD:
      return L"HDD";
    case VolumeType::Network:
      return L"Network";
    case VolumeType::RAM_Disk:
      return L"RAM Disk";
    default:
      return L"Unknown";
    }
  ...
  static constexpr size_t BackendCount() {
    return static_cast<size_t>(IOBackend::COUNT);
  }
  static constexpr size_t PriorityCount() {
    return static_cast<size_t>(IOPriority::COUNT);
  }
  static constexpr size_t VolumeTypeCount() {
    return static_cast<size_t>(VolumeType::COUNT);
  }
  static constexpr size_t PolicyCount() {
    return static_cast<size_t>(IOPolicy::COUNT);
  }

  static const wchar_t *PolicyName(IOPolicy p) {
    switch (p) {
    case IOPolicy::Sequential:
      return L"Sequential";
    case IOPolicy::ParallelBatch:
      return L"Parallel Batch";
    case IOPolicy::ScatterGather:
      return L"Scatter-Gather";
    default:
      return L"Unknown";
    }
  }
