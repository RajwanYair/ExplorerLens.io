...
public:
    ...
    IOCompletionPortBridgeConfig GetConfig() const { return m_config; }
    std::string GetName() const { return m_config.label; }

    uint32_t GetConcurrentThreads() const { return m_config.concurrentThreads; }
    bool IsPortValid() const { return m_initialized; }
