...
class RemoteRenderProxy
{
  public:
    ...
    explicit RemoteRenderProxy(ProxyTransport transport) noexcept : m_transport(transport) {}

    [[nodiscard]] ProxyTransport GetTransport() const noexcept
    {
        return m_transport;
    }
    ...
    [[nodiscard]] RenderState GetLastState() const noexcept
    {
        return m_lastState;
    }
    [[nodiscard]] int GetPendingCount() const noexcept
    {
        return m_pendingCount;
    }
    [[nodiscard]] int GetTimeoutMs() const noexcept
    {
        return m_timeoutMs;
    }
    ...
    [[nodiscard]] RenderResponse RenderFile(const std::wstring& filePath, int size = DEFAULT_SIZE) noexcept
    {
        RenderRequest req;
    ...
    {
        switch (transport) {
            case ProxyTransport::NamedPipe:
                return L"NamedPipe";
            case ProxyTransport::SharedMem:
                return L"SharedMem";
            case ProxyTransport::COM:
                return L"COM";
            case ProxyTransport::DirectCall:
                return L"DirectCall";
            default:
                return L"Unknown";
        }
