...
class ProductionPipelineIntegration
{
  public:
    ...
    bool IsParallelIOEnabled() const
    {
        return m_parallelIOEnabled;
    }
    bool IsPSOCacheEnabled() const
    {
        return m_psoCacheEnabled;
    }
    bool IsWarmingEnabled() const
    {
        return m_warmingEnabled;
    }
  ...
  private:
    ...
    HBITMAP LookupCache(const std::wstring& /*path*/, uint32_t /*size*/)
    {
        return nullptr;
    }
    ...
    {
        HANDLE hFile = CreateFileW(path.c_str(), GENERIC_READ, FILE_SHARE_READ | FILE_SHARE_DELETE, nullptr,
    ...
    HBITMAP GPUResize(const DecodedImage& /*decoded*/, uint32_t /*targetSize*/)
    {
        return nullptr;
    }
    HBITMAP CPUResize(const DecodedImage& /*decoded*/, uint32_t /*targetSize*/)
    {
        return nullptr;
    }
