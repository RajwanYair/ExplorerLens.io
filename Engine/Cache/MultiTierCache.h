...
public:
    ...
    virtual CacheTier GetTier() const = 0;
...
public:
    ...
    CacheTier GetTier() const override { return CacheTier::Memory; }
...
private:
    ...
    // Stats
    mutable TierStatistics m_stats{CacheTier::Memory};
...
public:
    ...
    CacheTier GetTier() const override { return CacheTier::SQLite; }
...
private:
    ...
    uint64_t m_maxSizeBytes;
    mutable std::mutex m_mutex;
    mutable TierStatistics m_stats{CacheTier::SQLite};
...
public:
    ...
    CacheTier GetTier() const override { return CacheTier::Disk; }
...
private:
    ...
    uint64_t m_maxSizeBytes;
    mutable std::mutex m_mutex;
    mutable TierStatistics m_stats{CacheTier::Disk};
