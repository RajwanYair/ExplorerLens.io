...
class CacheCoherencyManager
{
  public:
    ...
    bool Initialize(const CacheCoherencyConfig& config = {})
    {
        ...
        m_hSharedMem = CreateFileMappingW(INVALID_HANDLE_VALUE, nullptr, PAGE_READWRITE, 0,
                                          sizeof(SharedInvalidationBuffer), m_config.sharedMemName.c_str());
    ...
    // Get stats
    CacheCoherencyStats GetStats() const
    {
        return m_stats;
    }
