...
{
    switch (e) {
        case CacheTelemetryEvent::CacheHit:
            return "CacheHit";
        case CacheTelemetryEvent::CacheMiss:
            return "CacheMiss";
        case CacheTelemetryEvent::Eviction:
            return "Eviction";
        case CacheTelemetryEvent::Corruption:
            return "Corruption";
        default:
            return "Unknown";
    }
...
{
    switch (i) {
        case CacheTelemetryInterval::Realtime:
            return "Realtime";
        case CacheTelemetryInterval::Session:
            return "Session";
        case CacheTelemetryInterval::Daily:
            return "Daily";
        default:
            return "Unknown";
    }
...
class CacheTelemetryCollector
{
  public:
    ...
    uint32_t GetTotalEvents() const noexcept
    {
        return m_total;
    }
    ...
    TelemetrySnapshot Export() const
    {
        ...
        snap.evictionRate = m_total > 0 ? static_cast<float>(m_evictions) / static_cast<float>(m_total) : 0.0f;
        return snap;
    }
