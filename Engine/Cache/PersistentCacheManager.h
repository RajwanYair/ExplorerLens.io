...
public:
    static const wchar_t* BackendName(CacheBackend b) noexcept {
        ...
        case CacheBackend::LevelDB:   return L"LevelDB";
        case CacheBackend::MemoryMap: return L"Memory Map";
    ...
    static const wchar_t* PolicyName(InvalidationPolicy p) noexcept {
        ...
        case InvalidationPolicy::FileWatcher: return L"File Watcher";
        case InvalidationPolicy::Timer:       return L"Timer";
        case InvalidationPolicy::Explicit:    return L"Explicit";
