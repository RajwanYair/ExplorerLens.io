...
enum class TenantCacheTier : uint8_t {
    Hot = 0,
    Warm,
    Cold,
    Evicted,
...
enum class TenantIsolation : uint8_t {
    Strict = 0,
    Soft,
    Shared,
    COUNT
};
enum class TenantEvictPolicy : uint8_t {
    LRU = 0,
    LFU,
    ActivityScore,
    QuotaFirst,
...
class MultiTenantCacheManager
{
  public:
    ...
    {
        switch (t) {
            case TenantCacheTier::Hot:
                return L"Hot";
            case TenantCacheTier::Warm:
                return L"Warm";
            case TenantCacheTier::Cold:
                return L"Cold";
            case TenantCacheTier::Evicted:
                return L"Evicted";
            default:
                return L"Unknown";
        }
    ...
    {
        switch (i) {
            case TenantIsolation::Strict:
                return L"Strict";
            case TenantIsolation::Soft:
                return L"Soft";
            case TenantIsolation::Shared:
                return L"Shared";
            default:
                return L"Unknown";
        }
    ...
    {
        switch (p) {
            case TenantEvictPolicy::LRU:
                return L"LRU";
            case TenantEvictPolicy::LFU:
                return L"LFU";
            case TenantEvictPolicy::ActivityScore:
                return L"Activity Score";
            case TenantEvictPolicy::QuotaFirst:
                return L"Quota First";
            default:
                return L"Unknown";
        }
    }
    ...
    {
        return static_cast<size_t>(TenantCacheTier::COUNT);
    }
    static constexpr size_t IsolationCount()
    {
        return static_cast<size_t>(TenantIsolation::COUNT);
    }
    static constexpr size_t EvictPolicyCount()
    {
        return static_cast<size_t>(TenantEvictPolicy::COUNT);
    }
    static bool IsQuotaExceeded(const TenantCacheStats& s)
    {
