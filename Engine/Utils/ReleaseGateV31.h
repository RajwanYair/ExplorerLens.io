//==============================================================================
// DarkThumbs Engine — Sprint 344: Release Gate V31
...
public:
    static constexpr size_t KPICount() { return static_cast<size_t>(GateV31KPI::COUNT); }
    static const wchar_t* KPIName(GateV31KPI k) {
        switch(k) {
            case GateV31KPI::SubMsCacheP99:          return L"Cache P99 < 1 ms";
            case GateV31KPI::GPUDecodeSpeedup:       return L"GPU Decode ≥ 2× CPU";
            case GateV31KPI::ParallelIOThroughput:   return L"Parallel I/O ≥ 2 GB/s";
            case GateV31KPI::WorkingSetTarget:       return L"Working Set ≤ 128 MB";
            case GateV31KPI::SingleThumbTarget:      return L"Single Thumb ≤ 17 ms";
            case GateV31KPI::BatchThroughputTarget:  return L"Batch ≥ 235 img/sec";
            case GateV31KPI::CacheHitLatency:        return L"Cache Hit ≤ 5 ms P99";
            case GateV31KPI::FragmentationScore:     return L"Heap Frag ≤ 0.10";
            case GateV31KPI::LargePageAdoption:      return L"Large Pages Active";
            case GateV31KPI::PerfRegressionSuite:    return L"Perf Regression 100%";
