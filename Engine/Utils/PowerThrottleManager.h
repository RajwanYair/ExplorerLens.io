...
{
    static const char* names[] = {"None", "Light", "Moderate", "Aggressive", "Emergency"};
...
class PowerThrottleManager
{
  public:
    ...
    /// Get stats
    const PowerThrottleStats& GetStats() const
    {
        return m_stats;
    }
  ...
  private:
    void PollPowerState()
    {
        ...
        if (GetSystemPowerStatus(&sps)) {
            ...
            m_powerState.batteryPercent = (sps.BatteryLifePercent <= 100) ? sps.BatteryLifePercent : 100;
