...
class LocalizationEngine
{
  public:
    ...
    static uint32_t GetLocaleCount()
    {
        return static_cast<uint32_t>(LocaleInfo::COUNT);
    }

    /// Set the active locale
    void SetLocale(LocaleInfo locale);
    /// Get the active locale
    LocaleInfo GetLocale() const
    {
    ...
    bool IsRTL() const
    {
        return GetTextDirection(m_activeLocale) == TextDirection::RTL;
    }
...
{
    switch (c) {
        case StringCategory::UI:
            return "UI";
        case StringCategory::Error:
            return "Error";
        case StringCategory::Status:
            return "Status";
        case StringCategory::Tooltip:
            return "Tooltip";
        case StringCategory::Accessibility:
...
class CoreLocalizationEngine
{
  public:
    ...
    LocaleId GetCurrentLocale() const noexcept
    {
    ...
    {
        return {LocaleId::EnUS, LocaleId::DeDE, LocaleId::FrFR, LocaleId::JaJP, LocaleId::ZhCN};
    }
    ...
    uint32_t GetLocaleChangeCount() const noexcept
    {
        return m_localeChangeCount;
    }
