...
std::wstring FileHashEngine::ComputeHash(const uint8_t *data, size_t size,
                                         HashAlgorithm algo) {
...
bool FileHashEngine::VerifyHash(const std::wstring &expected,
