...
public:
    ...
    MemoryMappedLoader(MemoryMappedLoader&& o) noexcept
        : m_file(o.m_file), m_mapping(o.m_mapping), m_view(o.m_view), m_size(o.m_size)
    {
    ...
    [[nodiscard]] bool OpenRange(const std::wstring& path,
    ...
    [[nodiscard]] MappedRegion  Region()  const noexcept { return { static_cast<const uint8_t*>(m_view), m_size }; }
