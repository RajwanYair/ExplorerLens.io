...
const wchar_t* EnterpriseDeploymentManager::GetMethodName(DeploymentMethod method)
{
    switch (method) {
        case DeploymentMethod::Manual:
            return L"Manual";
        case DeploymentMethod::GPO:
            return L"Group Policy";
        case DeploymentMethod::SCCM:
            return L"SCCM";
        case DeploymentMethod::Intune:
            return L"Intune";
        case DeploymentMethod::WSUS:
            return L"WSUS";
        case DeploymentMethod::Custom:
            return L"Custom";
        default:
            return L"Unknown";
    }
...
{
    switch (type) {
        case PolicyType::MachinePol:
            return L"Machine Policy";
        case PolicyType::UserPol:
            return L"User Policy";
        case PolicyType::RegistryPol:
            return L"Registry Policy";
        case PolicyType::FilePol:
            return L"File Policy";
        default:
            return L"Unknown";
    }
}
