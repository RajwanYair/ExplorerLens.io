...
struct ReproducibilityReport
{
    ...
    {
        return divergingFiles == 0;
    }
};
class ReproducibleBuildVerifierV2
{
  public:
    void AddBaseline(BuildHashEntry e)
    {
        m_baseline.push_back(e);
    }
    void AddCandidate(BuildHashEntry e)
    {
        m_candidate.push_back(e);
    }
