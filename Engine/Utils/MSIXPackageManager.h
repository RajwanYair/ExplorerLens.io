...
inline PackageCapability operator|(PackageCapability a, PackageCapability b) {
    return static_cast<PackageCapability>(
...
struct MSIXConfig {
    std::wstring packageName = L"DarkThumbs";
    std::wstring publisherName = L"CN=DarkThumbs";
    std::wstring publisherDisplayName = L"DarkThumbs Project";
    ...
    PackageCapability capabilities =
        PackageCapability::RunFullTrust |
