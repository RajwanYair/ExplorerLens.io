...
void ConfigMigrationEngine::SetSourceConfig(const std::map<std::wstring, std::wstring>& config)
{
...
void ConfigMigrationEngine::ApplyRule(const MigrationRule& rule, MigrationResult& result)
{
    switch (rule.action) {
...
void ConfigMigrationEngine::AddDefaults(ConfigVersion targetVersion, MigrationResult& result)
{
...
bool ConfigMigrationEngine::ValidateConfig(const std::map<std::wstring, std::wstring>& config) const
{
    for (const auto& entry : m_schema) {
        if (entry.isRequired) {
...
{
    switch (version) {
        case ConfigVersion::V7_0:
            return L"v7.0";
        case ConfigVersion::V8_0:
            return L"v8.0";
        case ConfigVersion::V8_3:
            return L"v8.3";
        case ConfigVersion::V8_4:
            return L"v8.4";
        case ConfigVersion::V9_0:
            return L"v9.0";
        case ConfigVersion::V9_2:
            return L"v9.2";
        case ConfigVersion::V10_0:
            return L"v10.0";
        default:
            return L"Unknown";
    }
