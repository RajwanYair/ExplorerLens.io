//==============================================================================
// DarkThumbs Engine — Sprint 334: Release Gate V29
...
public:
    static constexpr size_t KPICount() { return static_cast<size_t>(GateV29KPI::COUNT); }
    static const wchar_t* KPIName(GateV29KPI k) {
        switch(k) {
            case GateV29KPI::EnterprisePolicyCompliance: return L"Enterprise Policy Compliance ≥ 95%";
            case GateV29KPI::SharePointTeamsThumbnails:  return L"SharePoint/Teams Thumbnail Generation";
            case GateV29KPI::MultiTenantCacheIsolation:  return L"Multi-Tenant Cache Isolation";
            case GateV29KPI::ComplianceLogImmutability:  return L"Compliance Log Immutability";
            case GateV29KPI::GDPRRetentionEnforced:      return L"GDPR Retention Policy Enforced";
            case GateV29KPI::IntuneGPOPoliciesApplied:   return L"Intune + GPO Coexistence";
            case GateV29KPI::CloudSyncDeltaEnabled:      return L"Cloud Delta Sync Active";
            case GateV29KPI::TenantQuotasEnforced:       return L"Tenant Cache Quotas Enforced";
            case GateV29KPI::DSRRedactionComplete:       return L"DSR Redaction Complete";
            case GateV29KPI::EnterpriseDocumentation:    return L"Enterprise Admin Documentation";
            case GateV29KPI::CloudIntegrationTests:      return L"Cloud Integration Tests 100%";
