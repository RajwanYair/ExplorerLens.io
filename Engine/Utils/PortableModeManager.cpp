...
PortableDetectionResult PortableModeManager::Detect() const
{
    ...
    HANDLE hTest =
        CreateFileW(testFile.c_str(), GENERIC_WRITE, 0, nullptr, CREATE_ALWAYS, FILE_ATTRIBUTE_TEMPORARY, nullptr);
...
bool PortableModeManager::SaveConfig(const std::map<std::wstring, std::wstring>& settings)
{
...
{
    switch (status) {
        case PortableStatus::Installed:
            return L"Installed";
        case PortableStatus::Portable:
            return L"Portable";
        case PortableStatus::Hybrid:
            return L"Hybrid";
        case PortableStatus::Unknown:
            return L"Unknown";
        default:
            return L"Unknown";
    }
...
const wchar_t* PortableModeManager::GetLocationName(StorageLocation location)
{
    switch (location) {
        case StorageLocation::Registry:
            return L"Registry";
        case StorageLocation::IniFile:
            return L"INI File";
        case StorageLocation::JsonFile:
            return L"JSON File";
        case StorageLocation::AppData:
            return L"AppData";
        case StorageLocation::ExeDirectory:
            return L"Exe Directory";
        default:
            return L"Unknown";
    }
}
