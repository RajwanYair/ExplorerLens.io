...
struct AuditReport
{
    ...
    double PassRate() const noexcept
    {
        ...
        for (const auto& iss : issues) {
            ...
            if (!found)
                failedIds.push_back(iss.elementId);
        }
...
class AccessibilityAuditPipeline
{
  public:
    ...
    {
        switch (c) {
            case WCAGSuccessCriterion::SC_1_1_1_NonTextContent:
                return "1.1.1 Non-text Content";
            case WCAGSuccessCriterion::SC_1_4_3_ContrastMinimum:
                return "1.4.3 Contrast (Minimum)";
            case WCAGSuccessCriterion::SC_1_4_11_NonTextContrast:
                return "1.4.11 Non-text Contrast";
            case WCAGSuccessCriterion::SC_4_1_2_NameRoleValue:
                return "4.1.2 Name, Role, Value";
            case WCAGSuccessCriterion::SC_2_1_1_Keyboard:
