...
HBITMAP ApplyEXIFOrientation(HBITMAP hBitmap, int orientation)
{
    ...
    switch (orientation) {
        ...
        case 2:  // Flip horizontal
            ...
            StretchBlt(hdcDst, bm.bmWidth, 0, -bm.bmWidth, bm.bmHeight, hdcSrc, 0, 0, bm.bmWidth, bm.bmHeight, SRCCOPY);
            break;

        case 3:  // 180 degrees rotation
            hRotated = CreateCompatibleBitmap(hdc, bm.bmWidth, bm.bmHeight);
            hOldDst = (HBITMAP)SelectObject(hdcDst, hRotated);
            StretchBlt(hdcDst, bm.bmWidth, bm.bmHeight, -bm.bmWidth, -bm.bmHeight, hdcSrc, 0, 0, bm.bmWidth,
                       bm.bmHeight, SRCCOPY);
            break;
        ...
        case 4:  // Flip vertical
            hRotated = CreateCompatibleBitmap(hdc, bm.bmWidth, bm.bmHeight);
            hOldDst = (HBITMAP)SelectObject(hdcDst, hRotated);
            StretchBlt(hdcDst, 0, bm.bmHeight, bm.bmWidth, -bm.bmHeight, hdcSrc, 0, 0, bm.bmWidth, bm.bmHeight, SRCCOPY);
            break;
