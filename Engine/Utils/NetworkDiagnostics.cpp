...
const wchar_t* NetworkDiagnostics::GetTestTypeName(NetTestType type)
{
    switch (type) {
        case NetTestType::Ping:
            return L"Ping";
        case NetTestType::DNSResolve:
            return L"DNS Resolve";
        case NetTestType::HTTPGet:
            return L"HTTP GET";
        case NetTestType::ProxyCheck:
            return L"Proxy Check";
        case NetTestType::TLSHandshake:
            return L"TLS Handshake";
        default:
            return L"Unknown";
    }
}
...
{
    switch (status) {
        case NetTestStatus::NotRun:
            return L"Not Run";
        case NetTestStatus::Running:
            return L"Running";
        case NetTestStatus::Passed:
            return L"Passed";
        case NetTestStatus::Failed:
            return L"Failed";
        case NetTestStatus::Timeout:
            return L"Timeout";
        case NetTestStatus::Skipped:
            return L"Skipped";
        default:
            return L"Unknown";
    }
