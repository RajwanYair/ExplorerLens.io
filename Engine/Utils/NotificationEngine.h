...
class NotificationEngine
{
  public:
    ...
    {
        return static_cast<uint32_t>(m_notifications.size());
    }
    ...
    // Callbacks
    void SetOnNotify(NotifyCallback callback)
    {
        m_onNotify = callback;
    }
    ...
    {
        m_defaultDurationMs = ms;
    }
    void SetMaxNotifications(uint32_t max)
    {
    ...
    {
        return static_cast<uint32_t>(NotifyType::Count);
    }
