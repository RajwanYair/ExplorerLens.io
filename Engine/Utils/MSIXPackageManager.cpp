...
MSIXPackageManager::MSIXPackageManager(const MSIXConfig& config) : m_config(config) {}
...
bool MSIXPackageManager::SignPackage(const std::wstring& packagePath, const std::wstring& certPath) const
{
