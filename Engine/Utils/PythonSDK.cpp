...
void PythonSDK::PopulateDecoders()
{
    ...
    // Standard decoders
    auto addDecoder = [&](const std::wstring& name, const std::wstring& desc, std::initializer_list<std::wstring> exts,
...
//------------------------------------------------------------------------------
PythonThumbnailResult PythonSDK::GenerateThumbnail(const std::wstring& filePath, uint32_t width, uint32_t height)
{
...
//------------------------------------------------------------------------------
PythonThumbnailResult PythonSDK::GenerateFromBuffer(const uint8_t* data, size_t size, const std::wstring& formatHint,
...
//------------------------------------------------------------------------------
PythonBatchResult PythonSDK::ProcessBatch(std::vector<BatchEntry>& entries, ProgressCallback callback)
{
