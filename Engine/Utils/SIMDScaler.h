...
public:
    ...
    static bool ScaleBGRA_Bilinear_AVX2(
        const uint8_t* srcData,
        uint32_t srcWidth,
        uint32_t srcHeight,
        uint32_t srcStride,
    ...
    static bool ScaleBGRA_Bilinear_SSE41(
        const uint8_t* srcData,
        uint32_t srcWidth,
        uint32_t srcHeight,
        uint32_t srcStride,
    ...
    static bool ScaleBGRA_Bilinear_Scalar(
        const uint8_t* srcData,
        uint32_t srcWidth,
        uint32_t srcHeight,
        uint32_t srcStride,
    ...
    static bool ScaleBGRA_Bicubic_AVX2(
        const uint8_t* srcData,
        uint32_t srcWidth,
        uint32_t srcHeight,
        uint32_t srcStride,
    ...
    static bool ScaleBGRA_Bicubic_Scalar(
        const uint8_t* srcData,
        uint32_t srcWidth,
        uint32_t srcHeight,
        uint32_t srcStride,
    ...
    static bool ScaleBGRA_NearestNeighbor(
        const uint8_t* srcData,
        uint32_t srcWidth,
        uint32_t srcHeight,
        uint32_t srcStride,
    ...
    static bool ScaleBGRA_Lanczos3_Scalar(
        const uint8_t* srcData,
        uint32_t srcWidth,
        uint32_t srcHeight,
        uint32_t srcStride,
    ...
    static bool ScaleBGRA_BoxFilter_SSE41(
        const uint8_t* srcData,
        uint32_t srcWidth,
        uint32_t srcHeight,
        uint32_t srcStride,
    ...
    static bool ScaleBGRA_BoxFilter_Scalar(
        const uint8_t* srcData,
        uint32_t srcWidth,
        uint32_t srcHeight,
        uint32_t srcStride,
    ...
    static bool ScaleBGRA_BoxFilter(
        const uint8_t* srcData,
        uint32_t srcWidth,
        uint32_t srcHeight,
        uint32_t srcStride,
    ...
    static void ConvertRGBtoBGR_AVX2(
        const uint8_t* rgb,
        uint8_t* bgr,
        uint32_t pixelCount
    );
    ...
    static void ConvertRGBAtoBGRA_AVX2(
        const uint8_t* rgba,
        uint8_t* bgra,
        uint32_t pixelCount
    );
    ...
    static void ConvertRGBtoBGR_Scalar(
        const uint8_t* rgb,
        uint8_t* bgr,
        uint32_t pixelCount
    );
    
    static void ConvertRGBAtoBGRA_Scalar(
        const uint8_t* rgba,
        uint8_t* bgra,
        uint32_t pixelCount
    );
    ...
    static void CalculateScaledSize(
        uint32_t srcWidth,
        uint32_t srcHeight,
        uint32_t maxSize,
        uint32_t& outWidth,
...
private:
    ...
    static __m256i BilinearInterpolate_AVX2(
        __m256i p00, __m256i p01, __m256i p10, __m256i p11,
        __m256i fracX, __m256i fracY
    );

    // Helper: Convert BGRA to planar for SIMD processing
    static void DeinterleaveBGRA_AVX2(
        const uint8_t* bgra,
    ...
    static void InterleaveBGRA_AVX2(
...
inline void SIMDScaler::CalculateScaledSize(
    uint32_t srcWidth,
    uint32_t srcHeight,
    uint32_t maxSize,
    uint32_t& outWidth,
...
inline bool SIMDScaler::ValidateDimensions(
    uint32_t srcWidth,
    uint32_t srcHeight,
    uint32_t dstWidth,
    uint32_t dstHeight
    ...
    return (srcWidth > 0 && srcHeight > 0 &&
            ...
            srcWidth <= 65536 && srcHeight <= 65536 &&
