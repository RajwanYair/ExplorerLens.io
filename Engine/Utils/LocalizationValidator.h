...
inline const LocaleProperties g_supportedLocales[] = {
    ...
    { "de-DE", LocaleDirection::LTR, 300, false },
    { "ja-JP", LocaleDirection::LTR, 200, false },
    { "zh-CN", LocaleDirection::LTR, 180, false },
    { "ko-KR", LocaleDirection::LTR, 200, false },
    { "ar-SA", LocaleDirection::RTL, 256, true  },
