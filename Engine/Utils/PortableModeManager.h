#pragma once
//==============================================================================
// PortableModeManager.h — Merged Portable Mode Module
//
// Contains:
//   - PortableMode: Portable detection, INI config, badges, overlay settings
//   - PortableModeManager: Core portable mode management class
//==============================================================================
