...
{
  public:
    explicit PageFileArenaAllocator(size_t reserveBytes) : m_total(reserveBytes)
    {
...
{
  public:
    explicit HugeTLBPagePool(HugePageSize pageSize) : m_pageSize(pageSize) {}
