    ...
    , public IPropertyStoreCapabilities
{
  public:
    ...
    STDMETHOD(GetLocation) (LPWSTR pszPathBuffer, DWORD cchMax, DWORD* pdwPriority, const SIZE* prgSize,
    ...
    STDMETHOD(GetThumbnail) (UINT cx, HBITMAP* phBmpThumbnail, WTS_ALPHATYPE* pdwAlpha);
