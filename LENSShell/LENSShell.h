 ...
 */
/* Compiler settings for LENSShell\LENSShell.idl:
...
ILENSShell : public IDispatch{public : };
...
typedef struct ILENSShellVtbl
{
    ...
    HRESULT(STDMETHODCALLTYPE* QueryInterface)(ILENSShell* This,
                                               /* [in] */ REFIID riid,
                                               /* [annotation][iid_is][out] */
                                               _COM_Outptr_ void** ppvObject);

    DECLSPEC_XFGVIRT(IUnknown, AddRef)
    ULONG(STDMETHODCALLTYPE* AddRef)(ILENSShell* This);

    DECLSPEC_XFGVIRT(IUnknown, Release)
    ULONG(STDMETHODCALLTYPE* Release)(ILENSShell* This);

    DECLSPEC_XFGVIRT(IDispatch, GetTypeInfoCount)
    HRESULT(STDMETHODCALLTYPE* GetTypeInfoCount)(ILENSShell* This,
                                                 /* [out] */ UINT* pctinfo);

    DECLSPEC_XFGVIRT(IDispatch, GetTypeInfo)
    HRESULT(STDMETHODCALLTYPE* GetTypeInfo)(ILENSShell* This,
                                            /* [in] */ UINT iTInfo,
                                            /* [in] */ LCID lcid,
                                            /* [out] */ ITypeInfo** ppTInfo);

    DECLSPEC_XFGVIRT(IDispatch, GetIDsOfNames)
    HRESULT(STDMETHODCALLTYPE* GetIDsOfNames)(ILENSShell* This,
                                              /* [in] */ REFIID riid,
    ...
    /* [local] */ HRESULT(STDMETHODCALLTYPE* Invoke)(ILENSShell* This,
                                                     /* [annotation][in] */
...
interface ILENSShell
{
    CONST_VTBL struct ILENSShellVtbl* lpVtbl;
                ...
                #define ILENSShell_AddRef(This) ((This)->lpVtbl->AddRef(This))

                #define ILENSShell_Release(This) ((This)->lpVtbl->Release(This))

                #define ILENSShell_GetTypeInfoCount(This, pctinfo) ((This)->lpVtbl->GetTypeInfoCount(This, pctinfo))
                ...
                #define ILENSShell_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult, pExcepInfo, \
                                          puArgErr)                                                                    \
...
class DECLSPEC_UUID("9E6ECB90-5A61-42BD-B851-D3297D9C7F39") LENSShell;
        #endif
...
class DECLSPEC_UUID("A7B3F4E1-9C2D-4E8F-B6A1-3D5E7F9C2B4A") LENSShellContextMenu;
        #endif
