...
#define IMGTYPE_IS_WEB(t)                                                                                         \
    ((t) == IMGTYPE_JPG || (t) == IMGTYPE_PNG || (t) == IMGTYPE_GIF || (t) == IMGTYPE_WEBP || (t) == IMGTYPE_AVIF \
     || (t) == IMGTYPE_JXL || (t) == IMGTYPE_SVG)

/// Check if an image type requires a specialized decoder
#define IMGTYPE_IS_SPECIAL(t)                                                                                   \
    ((t) == IMGTYPE_PSD || (t) == IMGTYPE_EXR || (t) == IMGTYPE_HDR || (t) == IMGTYPE_DDS || (t) == IMGTYPE_RAW \
     || (t) == IMGTYPE_VTF || (t) == IMGTYPE_KTX || (t) == IMGTYPE_DPX)

/// Check if an image type supports HDR/float pixel data
#define IMGTYPE_IS_HDR(t) ((t) == IMGTYPE_EXR || (t) == IMGTYPE_HDR || (t) == IMGTYPE_DPX)
