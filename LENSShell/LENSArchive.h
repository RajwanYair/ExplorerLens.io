...
// Modern image format types (standalone decoders)
...
// Generic document format type
#define LENSTYPE_DOCUMENT                                                      \
  81 // Generic document type (fallback for unspecified docs)

// Additional image format types
