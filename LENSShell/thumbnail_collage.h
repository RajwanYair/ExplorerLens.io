...
class ThumbnailCollage
{
  public:
    ...
    static HBITMAP CreateCollage(const std::vector<HBITMAP>& pages, int targetWidth, int targetHeight,
  ...
  private:
    ...
    static bool DrawBitmapToComposite(HDC hdcDest, int x, int y, int width, int height, HBITMAP hSrc);
};
