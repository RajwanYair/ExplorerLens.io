...
#define DT_LOG_DEBUG(category, msg)                                            \
  ExplorerLens::Logger::Instance().Log(ExplorerLens::LogLevel::LVL_DEBUG,          \
                                     category, msg, __FILE__, __LINE__)
#define DT_LOG_INFO(category, msg)                                             \
  ExplorerLens::Logger::Instance().Log(ExplorerLens::LogLevel::LVL_INFO, category, \
                                     msg, __FILE__, __LINE__)
#define DT_LOG_WARNING(category, msg)                                          \
  ExplorerLens::Logger::Instance().Log(ExplorerLens::LogLevel::LVL_WARNING,        \
                                     category, msg, __FILE__, __LINE__)
#define DT_LOG_ERROR(category, msg)                                            \
  ExplorerLens::Logger::Instance().Log(ExplorerLens::LogLevel::LVL_ERROR,          \
                                     category, msg, __FILE__, __LINE__)
#define DT_LOG_CRITICAL(category, msg)                                         \
  ExplorerLens::Logger::Instance().Log(ExplorerLens::LogLevel::LVL_CRITICAL,       \
                                     category, msg, __FILE__, __LINE__)
#define DT_LOG_HRESULT(level, category, operation, hr)                         \
  ExplorerLens::Logger::Instance().LogHRESULT(level, category, operation, hr,    \
                                            __FILE__, __LINE__)
