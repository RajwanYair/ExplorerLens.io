...
FORMAT_REGISTRY: dict[str, dict] = {
    # Comic Book Formats
    "cbz": {"name": "CBZ", "exts": [".cbz"], "group": "comic",
            "tip": "Comic Book ZIP Archive"},
    "cbr": {"name": "CBR", "exts": [".cbr"], "group": "comic",
            "tip": "Comic Book RAR Archive — Requires UnRAR"},
    "cb7": {"name": "CB7", "exts": [".cb7"], "group": "comic",
            "tip": "Comic Book 7-Zip Archive"},
    "cbt": {"name": "CBT", "exts": [".cbt"], "group": "comic",
            "tip": "Comic Book TAR Archive"},
    # E-Book Formats
    "epub": {"name": "EPUB", "exts": [".epub"], "group": "ebook",
             "tip": "Electronic Publication — Cover extraction from metadata"},
    "mobi": {"name": "MOBI", "exts": [".mobi"], "group": "ebook",
             "tip": "Mobipocket E-Book"},
    "azw":  {"name": "AZW", "exts": [".azw"], "group": "ebook",
             "tip": "Amazon Kindle Format"},
    "azw3": {"name": "AZW3", "exts": [".azw3"], "group": "ebook",
             "tip": "Kindle Format 8 (KF8)"},
    # Archive Formats
    "zip": {"name": "ZIP", "exts": [".zip"], "group": "archive",
            "tip": "Standard ZIP Archive — Thumbnails from first image inside"},
    "rar": {"name": "RAR", "exts": [".rar"], "group": "archive",
            "tip": "WinRAR Archive — Requires UnRAR"},
    "7z":  {"name": "7Z", "exts": [".7z"], "group": "archive",
            "tip": "7-Zip Archive — High compression ratio"},
    "tar": {"name": "TAR", "exts": [".tar", ".tar.gz", ".tar.bz2",
                                     ".tar.xz", ".tar.zst"], "group": "archive",
            "tip": "Tape Archive — Supports compressed variants"},
    # Photo Album & Other
    "phz": {"name": "PHZ", "exts": [".phz"], "group": "photo",
            "tip": "Photo ZIP Album — Optimized for photo collections"},
    "fb2": {"name": "FB2", "exts": [".fb2"], "group": "photo",
            "tip": "FictionBook E-Book — XML-based format"},
    # Modern Image Formats
    "webp": {"name": "WebP", "exts": [".webp"], "group": "image",
             "tip": "Modern Image Format — Fast, built-in decoder"},
    "heif": {"name": "HEIF/HEIC", "exts": [".heif", ".heic"], "group": "image",
             "tip": "High Efficiency Image — iPhone photos"},
    "avif": {"name": "AVIF", "exts": [".avif"], "group": "image",
             "tip": "AV1 Image Format — Fast via WIC"},
    "jxl":  {"name": "JPEG XL", "exts": [".jxl"], "group": "image",
             "tip": "Next-Gen Image Format"},
    # Media & Documents
    "video":    {"name": "Video", "exts": [".mp4", ".avi", ".mkv", ".mov",
                 ".wmv", ".webm", ".flv", ".m4v"], "group": "media",
                 "tip": "Video Files — Extract frame thumbnails"},
    "pdf":      {"name": "PDF", "exts": [".pdf"], "group": "media",
                 "tip": "PDF Documents — Uses embedded thumbnails when available"},
    "tiff":     {"name": "TIFF", "exts": [".tif", ".tiff"], "group": "media",
                 "tip": "TIFF Images — Supports multi-page"},
    "svg":      {"name": "SVG", "exts": [".svg", ".svgz"], "group": "media",
                 "tip": "SVG Vector Graphics — Scalable vector format"},
    "raw":      {"name": "RAW", "exts": [".cr2", ".cr3", ".nef", ".arw",
                 ".dng", ".orf", ".rw2", ".pef", ".raf", ".srw", ".nrw"],
                 "group": "media",
                 "tip": "RAW Camera Photos — Requires LibRaw"},
    # Professional Image Formats
    "psd": {"name": "PSD", "exts": [".psd"], "group": "pro_image",
            "tip": "Adobe Photoshop Document"},
    "dds": {"name": "DDS", "exts": [".dds"], "group": "pro_image",
            "tip": "DirectDraw Surface — GPU texture format"},
    "hdr": {"name": "HDR", "exts": [".hdr"], "group": "pro_image",
            "tip": "Radiance HDR Image"},
    "exr": {"name": "EXR", "exts": [".exr"], "group": "pro_image",
            "tip": "OpenEXR — Industry-standard HDR format"},
    "ppm": {"name": "PPM", "exts": [".ppm", ".pgm", ".pbm"],
            "group": "pro_image",
            "tip": "NetPBM Portable Image Formats"},
    "ico": {"name": "ICO", "exts": [".ico"], "group": "pro_image",
            "tip": "Windows Icon Format"},
    "qoi": {"name": "QOI", "exts": [".qoi"], "group": "pro_image",
            "tip": "Quite OK Image — Fast lossless format"},
    "tga": {"name": "TGA", "exts": [".tga"], "group": "pro_image",
            "tip": "Truevision TGA — Legacy image format"},
    # Specialized Formats
    "audio":    {"name": "Audio", "exts": [".mp3", ".wav", ".m4a", ".flac",
                 ".ogg", ".opus", ".wma", ".aac"], "group": "specialized",
                 "tip": "Audio Files — Cover art extraction"},
    "document": {"name": "Document", "exts": [".docx", ".pptx", ".xlsx",
                 ".doc", ".ppt", ".xls", ".odt", ".odp"], "group": "specialized",
                 "tip": "Office Documents — Embedded preview extraction"},
    "font":     {"name": "Font", "exts": [".ttf", ".otf", ".woff", ".woff2"],
                 "group": "specialized",
                 "tip": "Font Files — Glyph preview rendering"},
    "model":    {"name": "3D Model", "exts": [".obj", ".stl", ".ply",
                 ".gltf", ".glb", ".fbx", ".3ds"], "group": "specialized",
                 "tip": "3D Models — Wireframe/rendered preview"},
    # Extended Formats
    "ext_image":    {"name": "Extended Image", "exts": [".bmp", ".gif",
                     ".png", ".jpg", ".jpeg", ".jp2", ".eps", ".pcx",
                     ".xcf", ".jxr", ".ktx", ".vtf"],
                     "group": "extended",
                     "tip": "Additional image formats via WIC/fallback"},
    "texture":      {"name": "Texture", "exts": [".ktx", ".vtf", ".dds"],
                     "group": "extended",
                     "tip": "Game/GPU Texture formats"},
    "ext_archive":  {"name": "Extended Archive", "exts": [".gz", ".bz2",
                     ".xz", ".zst", ".lz4", ".cpio", ".iso", ".cab",
                     ".ar", ".deb"], "group": "extended",
                     "tip": "Additional archive formats via libarchive"},
    "ext_document": {"name": "Extended Document", "exts": [".djvu", ".chm"],
                     "group": "extended",
...
class Config:
    ...
    enabled_formats: dict[str, bool] = field(default_factory=lambda: {
        key: True for key in FORMAT_REGISTRY
    })
